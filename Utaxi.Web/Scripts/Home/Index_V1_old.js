        ...
        success: function (data) {
            ...
            $.each(obj.response, function () {
                ...
                if (this.FxedRateAC_S == "0") {
                    ...
                    appendRateText = appendRateText + "<label class='col-form-label DemoTooltipOffset btn btn-link' title='" + tooltipText + "'  onclick=ChooseVehicle_V1(" + this.category_id + ",1," + this.final_price_ac + "," + this.code + "," + this.discont_price_ac + ")><b>₹ " + this.final_price_ac + "</b></label>  </div>";
                    appendRateText = appendRateText + "<div class='col-md-3 col-6 cabName'><button type='button' class='btn btn-outline-primary booking1' onclick=ChooseVehicle_V1(" + this.category_id + ",1," + this.final_price_ac + "," + this.code + "," + this.discont_price_ac + ") value='" + this.final_price_ac + "'>Book Now</button>";
                }
        ...
        success: function (data) {
            ...
            $.each(obj.response, function () {
                ...
                if (this.final_price_ac == "0") {
                    ...
                    appendRateText = appendRateText + "<label class='col-form-label DemoTooltipOffset btn btn-link' onclick=ChooseVehicle_V1(" + this.car_category_id + ",1," + this.final_price_ac + "," + this.code + "," + this.discont_price_ac + ")><b>₹ " + this.final_price_ac + "</b></label>  </div>";
                    appendRateText = appendRateText + "<div class='col-md-3 col-6 cabName'><button type='button' class='btn btn-outline-primary booking1' onclick=ChooseVehicle_V1(" + this.car_category_id + ",1," + this.final_price_ac + "," + this.code + "," + this.discont_price_ac + ") value='" + this.final_price_ac + "'>Book Now</button>";                
                }
