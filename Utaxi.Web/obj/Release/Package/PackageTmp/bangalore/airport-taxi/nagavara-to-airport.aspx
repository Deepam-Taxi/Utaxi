    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group mt-2" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Nagavara, Bengaluru, Karnataka, India" placeholder="Nagavara, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Nagavara, Bengaluru, Karnataka, India" placeholder="Nagavara, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Nagavara</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
              <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kacharakanahalli-to-airport.aspx">Kacharakanahalli </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kaval-byrasandra-to-airport.aspx">Kaval Byrasandra  </a></td>
                            </tr>
                                <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/nagavara-ring-road-to-airport.aspx">Nagavara Ring Road  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/ombr-layout-to-airport.aspx">Ombr Layout  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/outer-ring-road-to-airport.aspx">Outer Ring Road  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/ramamurthy-nagar-to-airport.aspx">Ramamurthy Nagar  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/ramaswamipalya-to-airport.aspx">Ramaswamipalya  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/sadananda-nagar-to-airport.aspx">Sadananda Nagar  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/subanna-palya-to-airport.aspx">Subanna Palya  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/thanisandra-to-airport.aspx">Thanisandra </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/dinnur-to-airport.aspx">Dinnur </a></td>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Nagavara</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Nagavara -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Nagavara. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
