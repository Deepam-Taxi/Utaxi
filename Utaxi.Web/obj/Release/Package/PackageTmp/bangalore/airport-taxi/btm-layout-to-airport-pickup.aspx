        ...
        <div class="row" style="margin-top: 5px;">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    <div class="form-group well" style="text-align: center;" id="airportPickupOptions">
                        <label class="form-check-inline">
                            <input type="radio" class="form-check-input" name="pickupOption" id="rdAirportPickup" disabled checked value="1">Airport Pickup
                        </label>
                        <label class="form-check-inline">
                            <input type="radio" class="form-check-input" name="pickupOption" id="rdAirportDrop" disabled value="2">Airport Drop
                        </label>
                        <label class="form-check-inline">
                    ...
                    <div class="form-group" id="btnSearchNext">
                        ...
                        <input type="hidden" value="22289" id="hdndropPlaceID" />
                        <input type="hidden" value="564" id="hdnpickupPlaceID" />
                ...
                <div class="container" id="divAvailableRides">
                    <div class="card" style="background-color: #fdc922;margin-top: -36px;">
            ...
            <div class="col-md-6">
                <div class="card">
                    <h3 style="padding: 13px; text-align: center; font-size: 26px;">Taxi Service from BTM Layout</h3>
                    <div class="card-body">
                        <table style="width: 100%">
                            <tr>
                                <th>From</th>
                        ...
                        <table id="customers">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="https://www.utaxi.in/Home/Index">Book Now</a></td>
                                </tr>
