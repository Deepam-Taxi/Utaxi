    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group mt-2" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Peenya, Bengaluru, Karnataka, India" placeholder="Peenya, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Peenya, Bengaluru, Karnataka, India" placeholder="Peenya, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Peenya</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                         <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/tumkur-road-to-airport.aspx">Tumkur Road  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/vishwaneedam-to-airport.aspx">Vishwaneedam </a></td>
                            </tr>
                                <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/dasarahalli-to-airport.aspx">Dasarahalli </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/goraguntepalya-to-airport.aspx">Goraguntepalya </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/goripalya-to-airport.aspx">Goripalya </a></td>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Peenya</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Peenya -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Peenya. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
