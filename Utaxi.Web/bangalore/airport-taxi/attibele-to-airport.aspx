...
<html lang="en-us">
<head>
<title>Book Taxi  from Airport from Attibele to Airport Pickup Rs 474/-
</title>
<meta charset="utf-8" />
    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group mt-2" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Attibele, Karnataka, India" placeholder="Attibele, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group mt-2" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Attibele, Karnataka, India" placeholder="Attibele, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Attibele</h2>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Attibele</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Attibele -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Attibele. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
