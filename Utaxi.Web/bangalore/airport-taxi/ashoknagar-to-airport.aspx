...
<html lang="en-us">
<head>
    <title>Book Taxi  from Airport from Ashok nagar to Airport Pickup Rs 474/-
    </title>
    <meta charset="utf-8" />
    ...
    <main role="main" class="container">
        ...
        <div class="row" style="margin-top: 5px;">
                    ...
                    <div class="card-body">
                        <div class="container" id="divSearchRides">
                            ...
                            <div class="form-group mt-2" id="divPickup">
                                ...
                                <input type="text" class="form-control" value="Ashok Nagar, Bengaluru, Karnataka, India" placeholder="Ashok Nagar, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                            </div>
                            ...
                            <div class="form-group mt-2" id="divDrop">
                                ...
                                <input type="text" class="form-control" value="Ashok Nagar, Bengaluru, Karnataka, India" placeholder="Ashok Nagar, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
                            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Ashok Nagar</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                            <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/chamrajpet-to-airport.aspx">Chamrajpet</a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/vittal-nagar-to-airport.aspx">Vittal Nagar </a></td>
                            </tr>
                            <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/gaviopuram-extension-to-airport.aspx">Gaviopuram Extension </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/ashoknagar-to-airport.aspx">Ashoknagar</a></td>
                            </tr>
                            <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kr-road-to-airport.aspx">K.R. Road </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kanakapura-main-road-to-airport.aspx">Kanakapura Main Road </a></td>
                            </tr>
                            <tr>

                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/minerva-circle-to-airport.aspx">Minerva Circle </a></td>

                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/tata-silk-farm-to-airport.aspx">Tata Silk Farm </a></td>
                            </tr>

                            <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/vv-puram-to-airport.aspx">V.V.Puram </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/nr-colony-to-airport.aspx">N.R Colony </a></td>
                            </tr>
                            <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/new-timber-yard-layout-to-airport.aspx">New Timber Yard Layout </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/shankarpuram-to-airport.aspx">Shankarpuram</a></td>
                            </tr>
                            <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/governmemnt-electric-factory-to-airport.aspx">Governmemnt Electric Factory </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/basavanagudi-to-airport.aspx">Basavanagudi </a></td>
                            </tr>
            ...
            <div class="col-md-12">
                <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Ashok Nagar</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <p>
                                    <b>Cab services from Ashok Nagar -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Ashok Nagar. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
