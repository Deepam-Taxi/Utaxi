    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Medihalli, Karnataka, India" placeholder="Medihalli, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Medihalli, Karnataka, India" placeholder="Medihalli, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Medihalli</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                        <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/samethanahalli-to-airport.aspx">Samethanahalli </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/devanagundi-to-airport.aspx">Devanagundi  </a></td>
                            </tr>
                                <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kalkunte-to-airport.aspx">Kalkunte </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/muthusandra-to-airport.aspx">Muthusandra </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/chikkanahalli-to-airport.aspx">Chikkanahalli  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kugur-to-airport.aspx">Kugur </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/viswaneedam-to-airport.aspx">Viswaneedam </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/handenahalli-to-airport.aspx">Handenahalli </a></td>
                            </tr>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Medihalli</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Medihalli -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Medihalli. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
