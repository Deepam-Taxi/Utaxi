    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Kengeri, Bengaluru, Karnataka, India" placeholder="Kengeri, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Kengeri, Bengaluru, Karnataka, India" placeholder="Kengeri, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Kengeri</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                     <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kengeri-satellite-town-to-airport.aspx">Kengeri Satellite Town  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kumbalgodu-to-airport.aspx">Kumbalgodu </a></td>
                            </tr>
                                <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/madanayakahalli-to-airport.aspx">Madanayakahalli </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/mallathahalli-to-airport.aspx">Mallathahalli  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/mysore-road-to-airport.aspx">Mysore Road </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kumbalgodu-to-airport.aspx">Kumbalgodu </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/chunchanakuppe-to-airport.aspx">Chunchanakuppe </a></td>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Kengeri</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Kengeri -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Kengeri. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
