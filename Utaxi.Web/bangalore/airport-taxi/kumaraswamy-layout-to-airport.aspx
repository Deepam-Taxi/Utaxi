    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Kumaraswamy Layout, Bengaluru, Karnataka, India" placeholder="Kumaraswamy Layout, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Kumaraswamy Layout, Bengaluru, Karnataka, India" placeholder="Kumaraswamy Layout, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Kumaraswamy Layout</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                            <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/vasanthpura-to-airport.aspx">Vasanthpura </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kadarenahalli-to-airport.aspx">Kadarenahalli </a></td>
                            </tr>
                                <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/padmanabha-nagar-to-airport.aspx">Padmanabha Nagar  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/thyagaraja-nagar-to-airport.aspx">Thyagaraja Nagar  </a></td>
                            </tr>
                               <tr>
                              
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/vikramnagar-to-airport.aspx">Vikramnagar  </a></td>
                            </tr>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Kumaraswamy Layout</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Kumaraswamy Layout -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Kumaraswamy Layout. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
