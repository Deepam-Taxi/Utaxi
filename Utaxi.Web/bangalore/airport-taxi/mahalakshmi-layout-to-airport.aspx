    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Mahalakshmi Layout, Bengaluru, Karnataka, India" placeholder="Mahalakshmi Layout, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Mahalakshmi Layout, Bengaluru, Karnataka, India" placeholder="Mahalakshmi Layout, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Mahalakshmi Layout</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                             <tr>
                             
                         <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kurubarahalli-to-airport.aspx">Kurubarahalli </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/manjunatha-nagar-to-airport.aspx">Manjunatha Nagar  </a></td>
                            </tr>
                                <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/modi-hospital-road-to-airport.aspx">Modi Hospital Road  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/nandini-layout-to-airport.aspx">Nandini Layout  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/hampinagar-to-airport.aspx">Hampinagar </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kadabagere-to-airport.aspx">Kadabagere </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/khb-colony-to-airport.aspx">K.H.B Colony  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/basaveswaranagar-to-airport.aspx">Basaveshwaranagar </a></td>
                            </tr>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Mahalakshmi Layout</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Mahalakshmi Layout -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Mahalakshmi Layout. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
