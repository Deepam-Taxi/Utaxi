...
<head>
    <title>
        Book Airport Drop @ Rs.674/- | Airport Taxi Fares in Bengaluru
    </title>
    <meta charset="utf-8" />
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-134213901-1" type="9d84c72aea3a1a982a1e5438-text/javascript"></script>
    <script>
...
<div class="divAirportPickup row">
    <div class="row" style="margin: 5px 0px; width: 100%;">
        <div class="col-md-12">
            <div class="card classPackage mb-3 clsAiportDropSet0" style="text-align: center;">
                <h1 style="margin-top: 20px;">Airport Drop bangalore offers</h1>
            </div>
        </div>
    </div>
    <div class="row" style="margin:  5px 0px; width: 100%;">
                ...
                <div class="card-body">
                    <div class="container" id="divSearchRides">
                        <div class="form-group well" style="text-align: center;" id="airportPickupOptions">
                            ...
                            <label class="form-check-inline">
                                <input type="radio" class="form-check-input" name="pickupOption" id="rdAirportDrop" checked value="2">Airport Drop
                            </label>
                            <label class="form-check-inline">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                    <a href="https://www.facebook.com/utaxi12/?modal=admin_todo_tour" class="clsbookNow">
                                        <img style="width: 100%;" src="/Images/Social media Icon/facebook-icon-png-social-media-icons.png" title="Best Deals on Cab Booking follow us on Facebook" alt="get best offers on airport drop" />
                                    </a>
                                </div>
                                <div class="col-md-1"></div>
                                <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                    <a href="https://twitter.com/Utaxi3">
                                        <img style="width: 100%;" src="/Images/Social media Icon/twitter--social-media-icons-.png" title="Best Deals on Cab Booking follow us on Twitter" alt="see utaxi daily updates fo airport drop" />
                                    </a>
                                </div>
                                <div class="col-md-1"></div>
                                <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                    <a href="https://www.google.co.in/search?q=utaxi&oq=utaxi&aqs=chrome..69i57j69i60j35i39j69i61l3.6428j1j7&sourceid=chrome&ie=UTF-8#lrd=0x3bae151ddb3b9c3b:0x453bb66e876199fc,3,,,">
                                        <img style="width: 100%;" src="/Images/Social media Icon/21-social-media-icons.png" title="airport drop bangalore" />
                                    </a>
                                </div>
                                <div class="col-md-2"></div>
                            </div>
        ...
        <div class="col-md-6">
            <div class="card classPackage mb-6 clsAiportDropSet0">
                <div class="card-header boldfields">
                    Gallery
                </div>
                <div class="card-body">
                    <div id="carouselExampleIndicatorsAirportDrop" class="carousel slide" data-ride="carousel">
                        <ol class="carousel-indicators">
                            <li data-target="#carouselExampleIndicatorsAirportDrop" data-slide-to="0" class="active"></li>
                            <li data-target="#carouselExampleIndicatorsAirportDrop" data-slide-to="1"></li>
                            <li data-target="#carouselExampleIndicatorsAirportDrop" data-slide-to="2"></li>
                        </ol>
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="/Images/Airport Drop/utaxi-Airport-drop-in-banaglore.png" alt="Online Airport Taxi Booking" title="Airport Drop Rs.674/-" />
                            </div>
                            <div class="carousel-item">
                                <img src="/Images/Airport Drop/book-taxi-where-you-need-to-be-airport-drop.png" alt="Airport Pickup taxi " title="Airport Pickup Rs.774/-" />
                            </div>
                            <div class="carousel-item">
                                <img src="/Images/Airport Drop/book-suv-airport-drop.png" alt="Cab for Airport Drop" title="Book SUV for airport drop" />
                            </div>
                        </div>
                        <a class="carousel-control-prev" href="#carouselExampleIndicatorsAirportDrop" role="button" data-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="sr-only">Previous</span>
                        </a>
                        <a class="carousel-control-next" href="#carouselExampleIndicatorsAirportDrop" role="button" data-slide="next">
    ...
    <div class="row" style="margin:  5px 0px; width: 100%;">
        <div class="col-md-12 clsAiportDropSet0">
                ...
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            Airport drop for the time of <b>5:00 PM - 11:45 PM</b> would cost <b>Rs.674</b> for <b>Indica Non/AC</b>
                        </li>
                        <li class="list-group-item">
                            Airport drop for the time of <b>11:45 PM - 4:45 PM</b> would cost <b>Rs.774</b> for <b>Indica Non/AC</b>
                        </li>
                        <li class="list-group-item">
