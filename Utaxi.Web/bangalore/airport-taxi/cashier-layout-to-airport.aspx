    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Cashier Layout, BTM Layout 1, Bengaluru, Karnataka" placeholder="Cashier Layout, BTM Layout 1, Bengaluru, Karnataka" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Cashier Layout, BTM Layout 1, Bengaluru, Karnataka" placeholder="Cashier Layout, BTM Layout 1, Bengaluru, Karnataka" readonly id="dropPlaceSearch">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                <a href="https://www.google.co.in/search?q=utaxi&oq=utaxi&aqs=chrome..69i57j69i60j35i39j69i61l3.6428j1j7&sourceid=chrome&ie=UTF-8#lrd=0x3bae151ddb3b9c3b:0x453bb66e876199fc,3,,,">
                                    <img style="width: 100%;" src="~/Images/Social media Icon/google-plus-3-169 (1).png" alt="Cashier Layout water tank bus stop to bangalore airport" />
                                </a>
                            </div>
                            <div class="col-md-2"></div>
                        </div>
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Cashier Layout</h2>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Cashier Layout</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Cashier Layout -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Cashier Layout. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
