    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group mt-2" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Shivajinagar, Bengaluru, Karnataka, India" placeholder="Shivajinagar, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Shivajinagar, Bengaluru, Karnataka, India" placeholder="Shivajinagar, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Shivajinagar</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                     <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/jumma-masjid-road-to-airport.aspx">Jumma Masjid Road  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kamaraj-road-to-airport.aspx">Kamaraj Road  </a></td>
                            </tr>
                                <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/lady-curzon-roadto-airport">Lady Curzon Road </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/lakshmipuram-to-airport.aspx">Lakshmipuram </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/lavelle-road-to-airport.aspx">Lavelle Road  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/narayan-pillai-to-airport.aspx">Narayan Pillai  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/new-bamboo-bazar-to-airport.aspx">New Bamboo Bazar  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/queens-road-to-airport.aspx">Queens Road  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/tasker-town-to-airport.aspx">Tasker Town  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/infantry-road-to-airport.aspx">Infantry Road  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/vasanth-nagar-to-airport.aspx">Vasanth Nagar  </a></td>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Shivajinagar</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Shivajinagar -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Shivajinagar. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
