            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Madivala, Karnataka" placeholder="Madivala, Karnataka" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Madivala, Karnataka" placeholder="Madivala, Karnataka" readonly id="dropPlaceSearch">
