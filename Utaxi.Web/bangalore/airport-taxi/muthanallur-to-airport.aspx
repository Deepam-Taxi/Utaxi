            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Muthanallur, Bommasandra, Karnataka, India" placeholder="Muthanallur, Bommasandra, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Muthanallur, Bommasandra, Karnataka, India" placeholder="Muthanallur, Bommasandra, Karnataka, India" readonly id="dropPlaceSearch">
