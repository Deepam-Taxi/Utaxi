    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Jayanagar, Bengaluru, Karnataka, India" placeholder="Jayanagar, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Jayanagar, Bengaluru, Karnataka, India" placeholder="Jayanagar, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Jayanagar</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                            <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/yediyur-to-airport.aspx">Yediyur </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/tilaknagar-to-airport.aspx">Tilaknagar </a></td>
                            </tr>
                                <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/mavalli-to-airport.aspx">Mavalli  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/pasmpa-mahakavi-road-to-airport.aspx">Pasmpa Mahakavi Road  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/shankarpura-to-airport.aspx">Shankarpura </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/visveswarapuram-to-airport.aspx">Visveswarapuram </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/madhavan-park-to-airport.aspx">Madhavan Park  </a></td>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Jayanagar</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Jayanagar -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Jayanagar. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
