...
<html lang="en-us">
<head>
    <title>Book Taxi  from Airport from Bagmane techpark to Airport Pickup Rs 474/-
    </title>
    <meta charset="utf-8" />
    ...
    <main role="main" class="container">
        ...
        <div class="row" style="margin-top: 5px;">
                    ...
                    <div class="card-body">
                        <div class="container" id="divSearchRides">
                            ...
                            <div class="form-group mt-2" id="divPickup">
                                ...
                                <input type="text" class="form-control" value="Bagmane Tech Park, Krishnappa Garden, C V Raman Nagar, Bengaluru, Karnataka" placeholder="Bagmane Tech Park, Krishnappa Garden, C V Raman Nagar, Bengaluru, Karnataka" readonly id="pickupPlaceSearch">
                            </div>
                            ...
                            <div class="form-group mt-2" id="divDrop">
                                ...
                                <input type="text" class="form-control" value="Bagmane Tech Park, Krishnappa Garden, C V Raman Nagar, Bengaluru, Karnataka" placeholder="Bagmane Tech Park, Krishnappa Garden, C V Raman Nagar, Bengaluru, Karnataka" readonly id="dropPlaceSearch">
                            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Bagmane Tech Park</h2>
            ...
            <div class="col-md-12">
                <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Bagmane Tech Park</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Bagmane Tech Park -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Bagmane Tech Park. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
