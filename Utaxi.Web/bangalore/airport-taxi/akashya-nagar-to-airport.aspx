...
<html lang="en-us">
<head>
    <title>Book Taxi  from Airport from Akshaya nagar to Airport Pickup Rs 474/-
    </title>
    <meta charset="utf-8" />
...
<body>
    ...
    <main role="main" class="container">
        ...
        <div class="row" style="margin-top: 5px;">
                    ...
                    <div class="card-body">
                        <div class="container" id="divSearchRides">
                            ...
                            <div class="form-group mt-2" id="divPickup">
                                ...
                                <input type="text" class="form-control" value="Akshayanagar, Bengaluru, Karnataka" placeholder="Akshayanagar, Bengaluru, Karnataka" readonly id="pickupPlaceSearch">
                            </div>
                            ...
                            <div class="form-group mt-2" id="divDrop">
                                ...
                                <input type="text" class="form-control" value="Akshayanagar, Bengaluru, Karnataka" placeholder="Akshayanagar, Bengaluru, Karnataka" readonly id="dropPlaceSearch">
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                            <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/Akshayanagar-to-airport.aspx">Bannerghatta</a></td>
            ...
            <div class="col-md-12">
                <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Akshayanagar</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Akshayanagar -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Akshayanagar. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
