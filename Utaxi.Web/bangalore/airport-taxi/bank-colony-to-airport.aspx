...
<html lang="en-us">
<head>
    <title>Book Taxi  from Airport from Bank Colony to Airport Pickup Rs 474/-
    </title>
    <meta charset="utf-8" />
    ...
    <main role="main" class="container">
        ...
        <div class="row" style="margin-top: 5px;">
                    ...
                    <div class="card-body">
                        <div class="container" id="divSearchRides">
                            ...
                            <div class="form-group mt-2" id="divPickup">
                                ...
                                <input type="text" class="form-control" value="Bank Colony, Srinivasnagar, Banashankari, Bengaluru, Karnataka, India" placeholder="Bank Colony, Srinivasnagar, Banashankari, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                            </div>
                            ...
                            <div class="form-group mt-2" id="divDrop">
                                ...
                                <input type="text" class="form-control" value="Bank Colony, Srinivasnagar, Banashankari, Bengaluru, Karnataka, India" placeholder="Bank Colony, Srinivasnagar, Banashankari, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
                            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Bank Colony</h2>
            ...
            <div class="col-md-12">
                <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Bank Colony</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Bank Colony -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Bank Colony. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p>
                            Our customer support team works 24/7 for  365 days to ensure door to door pickup and drop from all parts of Bank Colony to Bengaluru International Airport our drivers will reach you safely as per your convenient time to catch your domestic or international flight.
