    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Whitefield, Bengaluru, Karnataka, India" placeholder="Whitefield, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Whitefield, Bengaluru, Karnataka, India" placeholder="Whitefield, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Whitefield</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                            <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/bidrahalli-to-airport.aspx">Bidrahalli  </a></td>
                                <td><a href="mahadevapura-to-airport.aspx">Mahadevapura </a></td>
                            </tr>
                                <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/hoodi-to-airport.aspx">Hoodi </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/immedihalli-to-airport.aspx">Immedihalli </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kannamangala-to-airport.aspx">Kannamangala </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kadugodi-to-airport.aspx">Kadugodi </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/ramagondanahalli-to-airport.aspx">Ramagondanahalli  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/varthur-to-airport.aspx">Varthur </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/gunjur-to-airport.aspx">Gunjur  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kundalahalli-to-airport.aspx">Kundalahalli </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/hoskote-to-airport.aspx">Hoskote </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kadugondanahalli-to-airport.aspx">Kadugondanahalli  </a></td>
                            </tr>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Whitefield</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Whitefield -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Whitefield. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
