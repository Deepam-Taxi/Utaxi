    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Ulsoor, Bengaluru, Karnataka, India" placeholder="Ulsoor, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Ulsoor, Bengaluru, Karnataka, India" placeholder="Ulsoor, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Ulsoor</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                     <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/air-force-hospital-to-airport.aspx">Air Force Hospital  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/hulsur-bazaar-to-airport.aspx">Hulsur Bazaar  </a></td>
                            </tr>
                                <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/someswarapura-temple-to-airport.aspx">Someswarapura Temple </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/narayan-pillai-street-to-airport.aspx">Narayan Pillai Street  </a></td>
                            </tr>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Ulsoor</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Ulsoor -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Ulsoor. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
