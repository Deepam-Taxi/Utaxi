    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Koramangala, Bengaluru, Karnataka, India" placeholder="Koramangala, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Koramangala, Bengaluru, Karnataka, India" placeholder="Koramangala, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Koramangala</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                          <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/stjohns-medical-college-to-airport.aspx"> </a>St Johns Medical College </td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kendriya-sadan-to-airport.aspx"> </a>Kendriya Sadan </td>
                            </tr>
                                <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/jakkasandra-to-airport.aspx">Jakkasandra </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/adugodi-to-airport.aspx">Adugodi </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/hosur-road-to-airport.aspx">Hosur Road </a> </td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/ejipura-to-airport.aspx">Ejipura </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/victoria-road-to-airport.aspx">Victoria Road  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/austin-town-to-airport.aspx">Austin Town </a> </td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/viveknagar-to-airport.aspx">VivekNagar </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/neelasandra-to-airport.aspx">Neelasandra </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/lakkasandra-to-airport.aspx">Lakkasandra  </a></td>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Koramangala</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Koramangala -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Koramangala. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
