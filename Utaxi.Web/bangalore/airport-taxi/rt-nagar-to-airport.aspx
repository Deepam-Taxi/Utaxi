    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group mt-2" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="RT Nagar, Bengaluru, Karnataka, India" placeholder="RT Nagar, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="RT Nagar, Bengaluru, Karnataka, India" placeholder="RT Nagar, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from RT Nagar</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                 <tr>
                                <td><a href="">Mekiri Circle  </a></td>
                                <td><a href="">Moti Nagar  </a></td>
                            </tr>
                                <tr>
                                <td><a href="">Munireddypalya  </a></td>
                                <td><a href="">Palace Road  </a></td>
                            </tr>
                               <tr>
                                <td><a href="">Pillana Garden  </a></td>
                                <td><a href="">Raj Mahal Vilas  </a></td>
                            </tr>
                               <tr>
                                <td><a href="">ST Johns Church Road  </a></td>
                                <td><a href="">Sultanpalya </a></td>
                            </tr>
                               <tr>
                                <td><a href="">Palace Guttahalli  </a></td>
                                <td><a href="">Vasanth Nagar  </a></td>
                            </tr>
                               <tr>
                                <td><a href="">Sultanpalya </a></td>
                                <td><a href="">Anandnagar  </a></td>
                            </tr>
                               <tr>
                                <td><a href="">Kaval Byrasandra  </a></td>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from RT Nagar</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from RT Nagar -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from RT Nagar. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
