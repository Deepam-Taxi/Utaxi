    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="HAL, Bengaluru, Karnataka, India" placeholder="HAL, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="HAL, Bengaluru, Karnataka, India" placeholder="HAL, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from HAL</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/jeevan-bhima-nagar-to-airport.aspx">Jeevan Bhima Nagar  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/indira-nagar-to-airport.aspx">Indira Nagar  </a></td>
                            </tr>
                                <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/cmh-road-to-airport.aspx">CMH Road  </a></td>
                            <td><a href="https://www.utaxi.in/bangalore/airport-taxi/murugeshpalya-to-airport.aspx">Murugeshpalya </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/domlur-to-airport.aspx">Domlur </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/indiranagar-to-airport.aspx">Indiranagar  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/bangalore-airport-to-airport.aspx">Bangalore Airport  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/nal-bangalore-to-airport.aspx">Nal Bangalore  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/vimapura-to-airport.aspx">Vimapura </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kodihalli-to-airport.aspx">Kodihalli </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/konena-agrahara-to-airport.aspx">Konena Agrahara  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/vinayaka-nagar-to-airport.aspx">Vinayaka Nagar  </a></td>
                            </tr>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from HAL</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from HAL -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from HAL. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
