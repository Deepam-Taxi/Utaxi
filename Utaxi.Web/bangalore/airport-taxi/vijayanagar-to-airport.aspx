    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group mt-2" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Vijayanagar, Bengaluru, Karnataka, India" placeholder="Vijayanagar, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Vijayanagar, Bengaluru, Karnataka, India" placeholder="Vijayanagar, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Vijayanagar</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                     <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/rpc-layout-to-airport.aspx">RPC Layout  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/shivananda-nagar-to-airport.aspx">Shivananda Nagar  </a></td>
                            </tr>
                               
                                <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/deepanjali-nagar-to-airport.aspx">Deepanjali nagar   </a></td>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Vijayanagar</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Vijayanagar -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Vijayanagar. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
