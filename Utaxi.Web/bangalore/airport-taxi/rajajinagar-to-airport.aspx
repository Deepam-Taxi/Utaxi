    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group mt-2" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Rajajinagar, Bengaluru, Karnataka, India" placeholder="Rajajinagar, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Rajajinagar, Bengaluru, Karnataka, India" placeholder="Rajajinagar, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Rajajinagar</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                           <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/prakash-nagar-to-airport.aspx">Prakash Nagar  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/bhashyam-circle-to-airport.aspx">Bhashyam Circle  </a></td>
                            </tr>
                                <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kamala-nagar-to-airport.aspx">Kamala Nagar  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/gayathri-nagar-to-airport.aspx">Gayathri Nagar  </a></td>
                            </tr>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Rajajinagar</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Rajajinagar -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Rajajinagar. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
