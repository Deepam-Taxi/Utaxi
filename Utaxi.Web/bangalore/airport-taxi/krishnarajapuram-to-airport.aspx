    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Krishnarajapuram, Bengaluru, Karnataka, India" placeholder="Krishnarajapuram, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Krishnarajapuram, Bengaluru, Karnataka, India" placeholder="Krishnarajapuram, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Krishnarajapuram</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                    <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/doorvaninagar-to-airport.aspx">Doorvaninagar </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/sivan-chetty-gardens-to-airport.aspx">Sivan Chetty Gardens  </a></td>
                            </tr>
                                <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/ramamurthy-nagar-to-airport.aspx">Ramamurthy Nagar  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/bhattarahalli-to-airport.aspx">Bhattarahalli </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/thambuchetty-palya-to-airport.aspx">Thambuchetty Palya  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/virgonagar-to-airport.aspx">Virgonagar </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/devasandra-to-airport.aspx">Devasandra </a></td>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Krishnarajapuram</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Krishnarajapuram -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Krishnarajapuram. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
