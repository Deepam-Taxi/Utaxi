    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="MLA Layout Main Rd, Kalena Agrahara, Bengaluru, Karnataka 560076" placeholder="MLA Layout Main Rd, Kalena Agrahara, Bengaluru, Karnataka 560076" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="MLA Layout Main Rd, Kalena Agrahara, Bengaluru, Karnataka 560076" placeholder="MLA Layout Main Rd, Kalena Agrahara, Bengaluru, Karnataka 560076" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from MLA Layout  Kalena Agrahara</h2>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from MLA Layout  Kalena Agrahara</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from MLA Layout  Kalena Agrahara -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from MLA Layout  Kalena Agrahara. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
