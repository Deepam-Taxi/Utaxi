    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Magadi Main Road, Gollarahatti, Bengaluru, Karnataka, India" placeholder="Magadi Main Road, Gollarahatti, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Magadi Main Road, Gollarahatti, Bengaluru, Karnataka, India" placeholder="Magadi Main Road, Gollarahatti, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Magadi Main Road</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                         <tr>
                                <td><a href="">Narasimharaja Colony  </a></td>
                                <td><a href="">Kamakshipalya  </a></td>
                            </tr>
                                <tr>
                                <td><a href="">Kanteerava Nagar  </a></td>
                                <td><a href="">Kottigepalya </a></td>
                            </tr>
                               <tr>
                                <td><a href="">Pantara Palya  </a></td>
                                <td><a href="">Sunkadakatte  </a></td>
                            </tr>
                               <tr>
                                <td><a href="">Pattegarhpalya </a></td>
                                <td><a href="">Vidyaranya Nagar  </a></td>
                            </tr>
                               <tr>
                                <td><a href="">Vivekananda Nagar  </a></td>
                                        <td><a href="">Jagajeevanram Nagar  </a></td>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Magadi Main Road</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Magadi Main Road -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Magadi Main Road. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
