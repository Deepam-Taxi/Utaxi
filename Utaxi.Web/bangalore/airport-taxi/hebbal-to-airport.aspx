    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Hebbal, Bengaluru, Karnataka, India" placeholder="Hebbal, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Hebbal, Bengaluru, Karnataka, India" placeholder="Hebbal, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Hebbal</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
            <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/jakkur-to-airport.aspx">Jakkur  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/vidyaranyapura-to-airport.aspx">Vidyaranyapura </a></td>
                            </tr>
                                <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/ramakrishna-hegde-nagar-to-airport.aspx">Ramakrishna Hegde Nagar  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/khb-colony-to-airport.aspx">KHB Colony  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/isro-anthariksha-bhavan-to-airport.aspx">ISRO Anthariksha Bhavan  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/hebbal-kempapura-to-airport.aspx">Hebbal Kempapura  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/malkand-lines-to-airport.aspx">Malkand Lines  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/mandalay-lines-to-airport.aspx">Mandalay Lines  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kempapura-to-airport.aspx">Kempapura  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kodigehalli-to-airport.aspx">Kodigehalli </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/sahakara-nagar-po-to-airport.aspx">Sahakara Nagar  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/vidyaranyapura-to-airport.aspx">Vidyaranyapura </a></td>
                            </tr>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Hebbal</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Hebbal -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Hebbal. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
