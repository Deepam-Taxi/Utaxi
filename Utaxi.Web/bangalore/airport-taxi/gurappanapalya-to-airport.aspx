    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Gurappanapalya, Bannerghatta Main Road, New Gurappana Palya, 1st Stage, BTM Layout 1, Bengaluru, Karnataka" placeholder="Gurappanapalya, Bannerghatta Main Road, New Gurappana Palya, 1st Stage, BTM Layout 1, Bengaluru, Karnataka" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Gurappanapalya, Bannerghatta Main Road, New Gurappana Palya, 1st Stage, BTM Layout 1, Bengaluru, Karnataka" placeholder="Gurappanapalya, Bannerghatta Main Road, New Gurappana Palya, 1st Stage, BTM Layout 1, Bengaluru, Karnataka" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Gurappanapalya</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                            <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/bismillah-nagar-to-airport.aspx">Bismillah Nagar </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/dollars-colony-btm-layout-to-airport.aspx">Dollars Colony Btm Layout </a></td>
                            </tr>
                             
                         <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/cashier-layout-to-airport.aspx">Cashier Layout  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/gurappanapalya-to-airport.aspx">Gurappanapalya</a></td>
                            </tr>
                             <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/jay-bheema-nagar-to-airport.aspx">Jay Bheema Nagar  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/jaydeva-hospital-to-airport.aspx">Jaydeva Hospital </a></td>
                            </tr>
                             <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/maruthi-nagar-to-airport.aspx">Maruthi Nagar  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/ns-palya-to-airport.aspx">Ns Palya </a></td>
                            </tr>
                             <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/silk-board-junction-to-airport.aspx">Silk Board Junction </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/tavarekere-to-airport.aspx">Tavarekere</a></td>
                            </tr>
                             <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/madivala-to-airport.aspx">Madivala </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/maruthi-nagar-to-airport.aspx">Maruthi Nagar</a> </td>
                            </tr>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Gurappanapalya</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Gurappanapalya -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Gurappanapalya. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
