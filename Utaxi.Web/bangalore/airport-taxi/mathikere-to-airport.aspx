    ...
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Mathikere, Bengaluru, Karnataka, India" placeholder="Mathikere, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="MathikereMathikere, Bengaluru, Karnataka, India" placeholder="Mathikere, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Mathikere</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                    <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/msr-road-to-airport.aspx"> MSR Road </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/indian-institute-of-science-to-airport.aspx">Indian Institute Of Science  </a></td>
                            </tr>
                                <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/ms-ramaiah-nagar-to-airport.aspx">Ms Ramaiah Nagar  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/muthyala-nagar-to-airport.aspx">Muthyala Nagar  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/mariyappanapalya-to-airport.aspx">Mariyappanapalya  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/nagashetty-halli-to-airport.aspx">Nagashetty Halli  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/new-bel-road-to-airport.aspx">New Bel Road  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/lottegollahalli-to-airport.aspx">Lottegollahalli  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/sanjay-nagar-to-airport.aspx">Sanjay Nagar  </a></td>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Mathikere</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Mathikere -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Mathikere. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
