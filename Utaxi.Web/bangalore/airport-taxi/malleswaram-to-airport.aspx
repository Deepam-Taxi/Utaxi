    ...
    <header>
        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            ...
            <div class="boldFields" style="font-size: 17px; color: white;">
                <a href="tel:08041466888" style="color: #fff;">Cal</a>
            </div>
        </nav>
    </header>
    <main role="main" class="container">
     ...
     <div class="card border-dark mb-3">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="divPickup">
                        ...
                        <input type="text" class="form-control" value="Malleswaram, Bengaluru, Karnataka, India" placeholder="Malleswaram, Bengaluru, Karnataka, India" readonly id="pickupPlaceSearch">
                    ...
                    <div class="form-group" id="divDrop">
                        ...
                        <input type="text" class="form-control" value="Malleswaram, Bengaluru, Karnataka, India" placeholder="Malleswaram, Bengaluru, Karnataka, India" readonly id="dropPlaceSearch">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <h2 style="padding: 13px; font-size: 23px;">Airport Pickup Services from Malleswaram</h2>
                    <div class="card-body" style="margin-top: -30px;">
                        <table style="width: 100%">
                          <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/lakshminarayanapura-to-airport.aspx">Lakshminarayanapura  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/magrath-road-to-airport.aspx">Magrath Road  </a></td>
                            </tr>
                                <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/agram-to-airport.aspx">Agram </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/malavalli-rama-rao-lane-to-airport.aspx">Malavalli Rama Rao Lane  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/margosa-road-to-airport.aspx">Margosa Road  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/ramamohanpuram-to-airport.aspx">Ramamohanpuram </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/sadashiva-nagar-to-airport.aspx">Sadashiva Nagar  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/sampige-main-road-to-airport.aspx">Sampige Main Road  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/sankey-cross-road-to-airport.aspx">Sankey Cross Road  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/shastri-nagar-to-airport.aspx">Shastri Nagar  </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/vyalikaval-to-airport.aspx">Vyalikaval  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/sadashivanagar-to-airport.aspx">Sadashivanagar </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/palace-guttahalli-to-airport.aspx">Palace Guttahalli  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/venkatarangapura-to-airport.aspx">Venkatarangapura </a></td>
                            </tr>
                               <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/subhash-nagar-to-airport.aspx">Subhash Nagar  </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/aranya-bhavan-to-airport.aspx">Aranya Bhavan  </a></td>
                            </tr>
                              
                              <tr>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/kp-wes-to-airport.aspx">KP West </a></td>
                                <td><a href="https://www.utaxi.in/bangalore/airport-taxi/state-bank-of-mysore-colony-to-airport.aspx">State Bank Of Mysore  </a></td>
                            </tr>
            ...
            <div class="col-md-12">
                   <div class="card">
                    <h1 style="padding: 13px; font-size: 26px;">Book Cabs from Malleswaram</h1>
                    <div class="card-body" style="margin-top: -30px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <b>Cab services from Malleswaram -</b>
                                U Taxi  Provides Best and affordable cheap cabs service in and around from Malleswaram. We have excellent cab monitoring systems that keep the liability of the cars and well trained, professional drivers.
