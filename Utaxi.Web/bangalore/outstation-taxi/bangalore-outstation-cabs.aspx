...
<head>
    ...
    <meta name="description" content="Car Rental for outstation, Outstation taxi services available 24/7, Book Sedan Cab @ Rs.9.00/- Per Km, Book Outstation taxi SUV @ 12.50/- Per Km, Tempo Traveler @ 14.00/- Per Km, Mini Bus for rental @ 22.00/- Per Km" />
    <meta name="keywords" content="one way outstation cab in bangalore, Outsation Cab booking, Outstation Cabs at Lowest Fare, innova for outstation,  Outsatation taxi in bangalore, Taxi services in Bangalore for Local or Outstation rides, outstation cabs tariff, outstation taxi from bangalore airport" />
    <meta name="google-site-verification" content="YjMSxJcF19Pz3R99oOVICxufyYFuH8zXhRt97-bkKnY" />
    <meta property="og:type" content="business.business">
    <meta property="og:title" content="Outstation Cabs Bangalore | Outstation Cab Booking in Bangalore | U Taxi">
    <meta property="og:description" content="Outstation Cabs Bangalore - Looking for outstation cabs in Bangalore for your trip? U Taxi provides cabs for outstation trips from Bangalore to all over India at affordable prices.">
    <meta property="og:url" content="https://www.utaxi.in/bangalore/airport-taxi/bangalore-airport-taxi-offers.aspx">
    ...
    <%--<script src="/Scripts/Home/outstation.js?Release=B2432797U8"></script>--%>
    <script src="/Scripts/Home/outstation_v1.js?Release=B2432797U8"></script>
...
<body>
    ...
    <main role="main" class="container">
            ...
            <div class="modal-dialog modal-dialog-centered" style="max-width: 535px !important;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img src="/Images/please-reach-out-to-our-customer-care-for-the-holiday-package-booking.png" alt="book outstation cabs in bangalore" />
                    </div>
        ...
        <div id="FD_FareModal" class="modal fade TripsTerms">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #ffc107;">
                        <h6 class="modal-title FD_FromPalceToPlace"></h6>
                    </div>
                    <div class="modal-body">
                        <table border="1" style="width: 100%">
                            <tr>
                                ...
                                <td>
                                     ...
                                     <h6><span class="FD_PickupDate">2021-01-21</span></h6>
                                </td>
                                <td>
                                    <h6><b>Vehicle Type:</b> </h6>
                                </td>
                                <td>

                                    <h6><span class="FD_VehicleType"></span><b><span class="FD_ACType"></span></b></h6>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                     <h6><span class="FD_PickupTime"></span></h6>
                                </td>
                                <td>
                                    <h6><b>Total No. of Seats:</b> </h6>
                                </td>
                                <td>
                                    <h6><span id="person">4</span></h6>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <h6><b>Estimated Price:</b> </h6>
                                </td>
                                <td>
                                    <h6><span> <b>₹</b><b><span style="font-size: 15px" class="FD_Rate"></span></b></span></h6>
                                </td>
                                <td>
                                </td>    
                            </tr>
                        ...
                        <table border="1" style="width: 100%">
                            ...
                            <tr>
                                <td><h6>Included Km :</h6></td>
                                <td><h6><span class="FD_distance"></span> km X <span class="FD_extra_km_charge"></span></h6></td>
                                <td><h6>₹<span class="FD_min_amount">20000</span></h6></td>
                            </tr>
                            <tr>
                                <td><h6>Additional fare/Km(beyond included Km)</h6></td>
                                <td><h6>₹<span class="FD_extra_km_charge">10</span>/KM</h6></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td><h6>Driver Allowance:</h6></td>
                                <td><h6><span style="font-size: 15px" class="FD_driver_travel_days"></span>X<span style="font-size: 15px" class="FD_driver_allowance"></span></h6></td>
                                <td><h6>₹<span style="font-size: 15px" class="FD_driver_day_allowance">500</span></h6></td>
                            </tr>
                            <tr>
                                <td><h6>GST(<span id="tax_nonac"></span>%)     :</h6></td>
                                <td></td>
                                <td><h6>₹<span style="font-size: 15px" id="total_price_tax_nonac">0</span></h6></td>
                            </tr>
                            <tr>
                                <th><h6>Discount Price:</h6></th>
                                <th></th>
                                <td><h6>-₹<span id="FD_discont_price">0</span></h6></td>
                            </tr>
                            <tr>
                                <td><h6>Total Fare :</h6></td>
                                <td></td>
                                <td><h6>₹<span class="FD_Rate"></span></h6></td>
                            </tr>
                        </table>
                        <ol class="TripsTerms">
                        </ol>
            ...
            <div class="row" style="margin: 5px 0px;">
                <div class="row" style="margin-top: 5px;">
                                    ...
                                    <div class="card-header boldFields">
                                        <ul class="nav nav-tabs card-header-tabs">
                                            <li class="nav-item active">
                                                <a class="nav-link" id="idOutstationTab" data-toggle="tab" href="#">Book Now</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="card-body">
                                        <div class="container" id="divSearchRides">
                                            ...
                                            <div class="form-group well" style="text-align: center;" id="outstationOptions">
                                                <label class="form-check-inline">
                                                    <input type="radio" class="form-check-input" name="outstationOption" id="rdOutstationOneway" checked value="">One way
                                                </label>
                                                <label class="form-check-inline">
                                            ...
                                            <div class="form-group" id="divPickupTime">
                                                <label for="pickupdatetime" class="boldFields">Start Date & Time<span class="mandatoryFields">*</span></label>
                                                <div class="row">
                                                    <div class="col-md-5">
                                            ...
                                            <div class="form-group" id="divDropTime">
                                                <label for="pickupdatetime" class="boldFields">End Date & Time<span class="mandatoryFields">*</span></label>
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <div class='input-group date'>
                                            ...
                                            <div class="form-group" id="btnSearchNext">
                                                ...
                                                <input type="hidden" value="" id="hdncarCategory" />
                                                <input type="hidden" value="" id="hdnEstimatedDistance" />
                                        ...
                                        <div class="container" id="divBooking">
                                            ...
                                            <div class="form-group well" id="paymentOption">
                                               <!-- <label class="form-check">
                                                    <input type="radio" class="form-check-input" name="bookingPayOption" id="rdPay100percent" value="1" disabled>Pay now - get <span class="badge badge-pill badge-info">5% discount </span>
                                                </label>
                                               <!--<label class="form-check">
                                                    <input type="radio" class="form-check-input" name="bookingPayOption" id="rdPay50percent" value="2" disabled>Pay 50% now - get <span class="badge badge-pill badge-info">2.5% discount </span>
                                                </label> -->
                                                <label class="form-check">
                                                    <input type="radio" class="form-check-input" name="bookingPayOption" id="rdPayLater" value="5">I want to Pay later
                                                </label>
												<label class="form-check">
                                                    <img src="https://www.utaxi.in/Images/payment-icon.png" style="height: 28px;">
                                                </label>
                                            </div>
                                            <div class="form-group">
                                                <label for="p_TripFare" class="p_TripFare"></label>
                                                <br />
                                                <label for="p_Discount" class="p_Discount"></label>
                                                <br />
                                ...
                                <div class="card classPackage mb-3">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item">
                                                <b>Starting & Closing  -</b>
                                                KM & Hours Opening & Closing Customer Starting Boarding point
                                            </li>
                                            <li class="list-group-item">
                                                <b>We Follow Calendar Day -</b>
                                                For Outstation, We Follow Calendar Day  is Counted as 1 day  [i.e.,00:00 Hrs to 23:59 Hrs]. 

                                            </li>
                                            <li class="list-group-item">
                                                <b>Up to 7 Passengers Vehicle  Minimum 250 kms -</b>
                                                Minimum Km :Suppose you need Cab for 2 days then we will charged Minimum 250 kms x 2 days = 500 kms expele : If drive One day 200km next day 300km no issue

                                            </li>
                                            <li class="list-group-item">
                                                <b>Above 12 Passengers Vehicle Minimum 300 kms -</b>
                                                Minimum Km :Suppose you need Cab for 2 days then we will charged Minimum 300 kms x 2 days = 600 kms expele : If drive One day 200km next day 300km no issue

                                            </li>
                                            <li class="list-group-item">
                                                <b>Driver Bata day  (Driver convenience) -</b>
                                                Day Driver Batta - Mandatory charge for 06:00 AM to 10:00 PM Late Night Batta - between 10:00 pm Hrs to 05:59 am Hrs "he Night Driver Batta comes in, only if the driver drives the cab "


                                            </li>

                                            <li class="list-group-item">
                                                <b>Inter-state tax, toll and parking -</b>
                                                This fare does not include inter-state tax, toll and parking. Charges if any, will be extra
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="card-footer">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5 cabName" style="text-align: right;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="card">
                                <div class="card-header boldFields">Outstation tariffs</div>
                                <div class="card-body">
                                    <br />
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card">
                                                <div class="card-header">
                                                    <a href="#" onclick="showBooknow();">
                                                        <img src="/Images/Outstation/450x600.png" alt="Doorstep Pickup & Drop" title="Outstation Cabs Services Available 24/7" style="width: 220px;" />
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="card">
                                                <div class="card-header">
                                                    <a href="#" onclick="showBooknow();">
                                                        <img src="/Images/Outstation/sedan-4passanger-travel-outstation-cab-taxi-chepest-rate-in-bangalore.png" alt="Hire outstation and local AC cab" title="Sedan fares at Rs. 8/km" style="width: 220px;" />
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card">
                                                <div class="card-header">
                                                    <a href="#" onclick="showBooknow();">
                                                        <img src="/Images/Outstation/toyota--innova-6passanger-travel-outstation-cab-taxi-chepest-rate-in-bangalore.png" alt="innova taxi for rental service" title="innova fares at Rs.12/km" style="width: 220px;" />
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="card">
                                                <div class="card-header">
                                                    <a href="#" onclick="showBooknow();">
                                                        <img src="/Images/Outstation/suv-7passanger-travel-outstation-cab-taxi-chepest-rate-in-bangalore.png" alt="suv car for rent in Bangalore" title="suv fares at Rs.12.50/km" style="width: 220px;" />
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card">
                                                <div class="card-header">
                                                    <a href="#" onclick="showBooknow();">
                                                        <img src="/Images/Outstation/tempo-traveler-12passanger-travel-outstation-cab-taxi-chepest-rate-in-bangalore.png" alt="Tempo Traveller rent in Bangalore" title="Tempo Traveller fare at Rs.14/km" style="width: 220px;" />
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="card">
                                                <div class="card-header">
                                                    <a href="#" onclick="showBooknow();">
                                                        <img src="/Images/Outstation/mini-bus-4passanger-travel-outstation-cab-taxi-chepest-rate-in-bangalore.png" alt="mini bus for rent in bangalore" title="mini bus fare at Rs.22/km" style="width: 220px;" />
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
