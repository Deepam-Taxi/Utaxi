...
<head>
    <title>
        Taxi  for Hogenakkal  Falls | Up to 4 Passenger Travel @ Rs.3119/-
    </title>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="robots" content="index, follow" />
    <meta name="description" content="Hogenakkal waterfalls is one of the good place in Dharmapuri, taxi from bangalore to hogenakkal falls, Book Cab for Hogenakkal Oneway &amp; Round Trip" />
    <meta name="keywords" content="Good one day trip but risky place for boating, Cheap Taxi Booking One day trip Hogenakkal waterfalls , Car Rental Services u taxi , Online Cab Booking, hogenakkal boating, Book Taxi for Hogenakkal, Hogenakkal Falls 1 day Tourist Places, hogenakkal falls tamil nadu, hogenakkal boat house" />
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 535px !important;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="/Images/please-reach-out-to-our-customer-care-for-the-holiday-package-booking.png" alt="hogenakkal falls from bangalore" />
            </div>
...
<div class="row" style="margin-top: 5px;">
    <div class="col-md-12">
        <div class="card classPackage mb-3" style="text-align: center;">
            <h1 style="margin-top: 20px;">Hogenakkal Waterfalls</h1>
        </div>
    </div>
</div>
<div class="row" style="margin-top: 5px;">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="btnSearchNext">
                        ...
                        <input type="hidden" id="hdnPackageType" value="36" />
                ...
                <div id="divBookingSuccess" class="container">
                    ...
                    <div class="form-group">
                        <div class="alert row" style="margin-left: -22px;">
                            <img style="width: 100%;" src="/Images/feedback.png" title="bangalore airport taxi" alt="airport taxi offers" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                <a href="https://www.facebook.com/utaxi12/?modal=admin_todo_tour" class="clsbookNow">
                                    <img style="width: 100%;" src="/Images/Social media Icon/facebook-icon-png-social-media-icons.png" alt="best time to visit hogenakkal falls" />
                                </a>
                            </div>
                            <div class="col-md-1"></div>
                            <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                <a href="https://twitter.com/Utaxi3">
                                    <img style="width: 100%;" src="/Images/Social media Icon/twitter--social-media-icons-.png" alt="places to visit near hogenakkal falls" />
                                </a>
                            </div>
                            <div class="col-md-1"></div>
                            <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                <a href="https://www.google.co.in/search?q=utaxi&oq=utaxi&aqs=chrome..69i57j69i60j35i39j69i61l3.6428j1j7&sourceid=chrome&ie=UTF-8#lrd=0x3bae151ddb3b9c3b:0x453bb66e876199fc,3,,,">
                                    <img style="width: 100%;" src="/Images/Social media Icon/google-plus-3-169 (1).png" alt="hogenakkal falls to bangalore" />
                                </a>
                            </div>
                            <div class="col-md-2"></div>
                        </div>
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/Images/Package/Hogenakkal Falls/Hogenakkal-Falls--Tourist-Places-to-Visit-&-Tour-Packages-1.png" alt="hogenakkal falls outstation" title="Onde place to visit Hogenakkal " />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Hogenakkal Falls/Hogenakkal-Falls--Tourist-Places-to-Visit-&-Tour-Packages-2.png" alt="bangalore to hogenakkal one day trip" title="attraction of this falls are boating in Coracles" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Hogenakkal Falls/Hogenakkal-Falls--Tourist-Places-to-Visit-&-Tour-Packages-3.png" alt="book cabs for hogenakkal with U taxi" title="Very Dangerous Place - Hogenakkal Falls" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Hogenakkal Falls/Hogenakkal-Falls--Tourist-Places-to-Visit-&-Tour-Packages.png" alt="Dharmapuri to Hogenakkal Distance, Duration" title="Hogenakkal Falls | Tourist Places to Visit in summer" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Hogenakkal Falls/Hogenakkal-Falls--Tourist-Places-to-Visit-&-Tour-Packages4.png" alt="bangalore to hogenakkal tempo traveller with U taxi" title="Awesome waterfall near Bangalore " />
                        </div>

                        <div class="carousel-item">
                            <img src="/Images/Package/Hogenakkal Falls/hogenakkal-falls-people-boarding-boat-utaxi.jpg" alt="Waterfalls near Bangalore cabservices" title="hogenakkal falls boating" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Hogenakkal Falls/Waterfalls-near-Bangalore.jpg" alt="bangalore to hogenakkal taxi rental" title="Massage & Bath an eyesore" />
                        </div>
                    </div>
...
<div class="row" style="margin-top: 5px;">
    ...
    <div class="col-md-12">
        <div class="card classPackage mb-3">
            <div class="card-header boldfields">
                <h3>Book Bangalore to Hogenakkal Cabs Oneway & Round Trip </h3>
            </div>
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        <h5>Hogenakkal Waterfalls - The Niagara of India</h5>
                        <p>Hogenakkal falls, also called as “Niagara of India”, is in Dharmapuri district of Tamil Nadu. It is exactly situated at about 45 kilometers away from Dharmapuri town and near Tamil Nadu-Karnataka state border.</p>
                        <p>Hogenakkal is called as Marikottayam in Tamil. The word Hogenakkal is formed by two Kannada words, Hoge and Kal which translates to Smoke(Hoge) and Rock(Kal). It is named because of the smoke like drizzle that emanates when the water hits the rock in falls.</p>
                        <h5>Bangalore to Hogenakkal distance,Price and Time</h5>
                        <p>Bangalore to Hogenakkal distance is approximately 150 km by car; it will take close to 3 Hours 30 Minutes. Our car rental roundtrip calculation is 300 Kms.</p>
                        <p>Hogenakkal falls is formed by River Cauvery while entering Tamil Nadu state at Hogenakkal. The water from the falls fills the Stanley Reservoir, commonly called as Mettur dam. Hogenakkal falls has around 14 sub-falls like channels and flows through rocky surface.</p>

                        <p>At somes places, the water from the falls run into 20 to 25 meters in depth in the rocky surface creating thunder like noise throughout the place. It is also one of the biggest falls in Tamil Nadu and the Carbonite rocks found in this falls is said to be one of the oldest in the whole world.</p>
                        <h5>Attraction places</h5>
                        <p>The main attraction of this falls are boating in Coracles (Parisal in Tamil), tasting fresh fish at various fish stalls around the falls, There is a mini zoo and a crocodile park near the falls.</p>
                        <b>Boating -</b>Boating in Hogenakkal is allowed during the dry-season as the water falls are not strong enough to disrupt the passage of the boats.
                        <div id="Boating" style="display:none">
                            <p>
                                This is the main source of income for these boat operators. The coracles are about 2.24 m (7 ft 4 in) in diameter, but still can take a load of eight persons at a time.[12] These coracles are made of bamboo, and with all materials available takes about a day to build. The bottom of the boats are made waterproof by the use of hides, but sometimes with sheets of plastic.[13] Use of plastics in the Hogenakkal vicinity, not just for boats, has been criticised due to problems with pollution.[14] These boats are steered and propelled using a single paddle, making them unique. The coracles are locally called parisal in Tamil and
                            ...
                            <h5>Best time to visit Hogenakkal Waterfalls</h5>
                            <p>Hogenakkal falls can be visited around the year but best time is after the monsoon time. Please note that, the boating is banned during monsoon time due to heavy water flow.</p>
                        </div>
                        <a href="https://www.utaxi.in/Home/Packages" class="nav-toggle">Book Cab for Hogenakkal Waterfalls</a>
                    </li>
                </ul>
            </div>
        </div>
