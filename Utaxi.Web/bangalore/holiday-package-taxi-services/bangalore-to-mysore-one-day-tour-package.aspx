...
<head>
    <title>
        One Day Trip Mysore | Mysore One Day Packages @ Rs.3199/-
    </title>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="robots" content="index, follow" />
    <meta name="description" content="Book Bangalore to Mysore cab with u taxi, One Day Mysore Local Sightseeing Cabs, Mysore Sightseeing Taxi  " />
    <meta name="keywords" content="bangalore to mysore cab service, Taxi Service from Bangalore to Mysore, One way Cab from Bangalore, Taxi Service in Mysore, Channapatna Toys in mysore. One Day Trip To Mysore Climb Up to the Chamundi Temple. Admire the Mysore Palace" />
    ...
    <script src="/bundles/bootstrap?v=P3gSWVPEN0cidpSuYvwnm9DyKAymjZBknZulpjfK0Uo1"></script>
...
<script src="/bundles/jBox?v=MOt_If2wnzb6RrhNFsTr9dmXOvE-z9lubC2DNO9WDJk1"></script>

<link href="/Content/jBox?v=q3JXv8Zwq6Hj_67dPLmXNpN7iYX_y8vBFEv6t4_Bd0Q1" rel="stylesheet"/>
        
        <script src="../../Scripts/Home/OustationPackage.js"></script>
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 535px !important;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="/Images/please-reach-out-to-our-customer-care-for-the-holiday-package-booking.png" alt="8 hours 80 km mysore package" />
            </div>
...
<div class="row" style="margin-top: 5px;">
    <div class="col-md-12">
        <div class="card classPackage mb-3" style="text-align: center;">
            <h1 style="margin-top: 20px;">Mysore Tour Packages at Best Price with utaxi</h1>
        </div>
    </div>
</div>
<div class="row" style="margin-top: 5px;">
                ...
                <div id="divBookingSuccess" class="container">
                    ...
                    <div class="form-group">
                        <div class="alert row" style="margin-left: -22px;">
                            <img style="width: 100%;" src="/Images/feedback.png" alt="bangalore to mysore taxi" title="Book airport cab for offers" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                <a href="https://www.facebook.com/utaxi12/?modal=admin_todo_tour" class="clsbookNow">
                                    <img style="width: 100%;" src="/Images/Social media Icon/facebook-icon-png-social-media-icons.png" alt="taxi service in mysore" />
                                </a>
                            </div>
                            <div class="col-md-1"></div>
                            <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                <a href="https://twitter.com/Utaxi3">
                                    <img style="width: 100%;" src="/Images/Social media Icon/twitter--social-media-icons-.png"  alt="mysore to bangalore airport taxi"/>
                                </a>
                            </div>
                            <div class="col-md-1"></div>
                            <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                <a href="https://www.google.co.in/search?q=utaxi&oq=utaxi&aqs=chrome..69i57j69i60j35i39j69i61l3.6428j1j7&sourceid=chrome&ie=UTF-8#lrd=0x3bae151ddb3b9c3b:0x453bb66e876199fc,3,,,">
                                    <img style="width: 100%;" src="/Images/Social media Icon/google-plus-3-169 (1).png" alt="bangalore airport to mysore taxi fare" />
                                </a>
                            </div>
                            <div class="col-md-2"></div>
                        </div>
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/Images/Package/Mysore/myosre_one_day_outstation_package _brindavan_garden_water_show_krs_garden_water_ founten.png" alt="Book Banglore to Mysore Taxi Services" title="Brindavan Garden Water Show" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Mysore/myosre_one_day_outstation_package_Chamundi_Hills_Temple_&amp;_Mysore_Top_view.png" alt="Book taxi from Bangalore to Mysore at best price. Outstation Cab Service. Reliable and cheapest" title="Chamundi Hills Temple Mysore Top view" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Mysore/myosre_one_day_outstation_package_karanji_lake_mysore.png" alt="Book Mysore Bangalore Taxi Just at Rs 3199" title="Karanji Lake, Mysore" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Mysore/myosre_one_day_outstation_package_mahishasura_statue_at_chamundi_hills.png" alt="Book Mysore Holiday Travel Packages" title="Mahishasura and Nandi, Chamundi Hills" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Mysore/myosre_one_day_outstation_package_mysore_-wax_-museum_.png" alt="Mysore Local Sightseeing Tour Packages with utaxi" title="Melody World Wax Museum in Mysore" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Mysore/myosre_one_day_outstation_package_mysore_palace_day.png" alt="Mysore Sightseeing One Day Car Package with Utaxi" title="Historical Palace and a Royal Residence at Mysore" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Mysore/myosre_one_day_outstation_package_mysore_palace_night_.png" alt="Mysore Maharaja Palace, timings, entry ticket cost, price, fee - Mysore" title="Mysore Maharaja Palace" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Mysore/myosre_one_day_outstation_package_mysore_sand_sculpture_museum_.png" alt="bangalore to mysore cab package" title="Mysore Sand Sculpture Museum" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Mysore/myosre_one_day_outstation_package_mysore_zoo.png" alt="cab for Mysore Zoo" title="Mysore Zoo - Mysore Tourism" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Mysore/myosre_one_day_outstation_package_nandi_statue_mysore_chamundi_hills_.png" alt="book utaxi for Nandi Statue at Chamundi Hills" title=" Nandi Statue at Chamundi Hills" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Mysore/myosre_one_day_outstation_package_philomena_church_.png" alt="bangalore to mysore cab one way" title="St. Philomena's Church, Mysuru (Mysore)" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Mysore/myosre_one_day_outstation_package _brindavan_garden_krs_garden_water_ founten.png" alt="Bangalore to Mysore Taxi Fare Details" title="Brindavan Gardens & KRS Dam" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Mysore/myosre_one_day_outstation_package_Chamundi_Hills_Temple_Mysore_Top_view.png" alt="Book Mysore to Coorg Taxi Services" title="Chamundi Hills Temple Mysore" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Mysore/myosre_one_day_outstation_package_mysore_zoo (2).png" alt="cab for mysore to coorg" title="Sri Chamarajendra Zoological Gardens Mysore ZOO" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Mysore/myosre_one_day_outstation_package_philomena_church_ (2).png" alt="bangalore airport to Mysore taxi services" title="St. Philomena's Cathedral, Mysore" />
                        </div>
...
<div class="row" style="margin-top: 5px;">
    ...
    <div class="col-md-12">
        <div class="card classPackage mb-3">
            <div class="card-header boldfields">
                ...
                <h4>Book Cab from Bangalore to Mysore Tour Package</h4>
            </div>
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    <h5>About the trip</h5>
                    <li class="list-group-item">
                        If the vehicle start from 6am have the breakfast on the way max half an hr and can reach to Chamundi Hills at 10 30am
                    </li>
                    <li class="list-group-item">
                        Upto 1 hour can spend in visiting temple 11 30am and after that it will take half an hour to reach Karanji Lake and can see the open Birds ,
                        can enjoy the children park and boating for 1 hr it will be 1 pm
                    </li>
                    <li class="list-group-item">
                        then to Zoo only ten mints way Mysore Zoo 1 15 pm (if u go by walk in the zoo it will take min 3 hrs or else u can have the inside zoo bus it will show the complete zoo in 1 hr and the bus will charge you extra per head ),
                        2 15 pm then after that spend for lunch near zoo for 1 hr, it will be 3 pm ,
                    </li>
                    <li class="list-group-item">
                        From Zoo to Mysore palace it will take 15 mints travel time and you can spend 1 hr in the palace 4 30 pm
                    </li>
                    <li class="list-group-item">
                        Thereafter to St. Philomena Church it will take 10 mints and you can spend half an hr the time will be around 5 30pm then finally
                    </li>
                    <li class="list-group-item">
                        Last visit to Brindavan Gardens ( KRS Dam) 6 pm their you can visit the garden, boating and water falls
                        and the musical fountain upto 8pm and after that you can come back to Bangalore and reach around 11 45 pm including dinner on the way.
                    </li>
                    <li class="list-group-item">
                        Optional
                        While coming on the way from chamundi hills you can have a visit also in Sand and Wax Museum with the entry tickets of Rs-50/head respectively.
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="col-md-12">
        <div class="card classPackage mb-3">
            <div class="card-header boldfields">
                <h5>Mysore Sightseeing One Day Package and Tourist attractions Places</h5>
            </div>
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        <b>Chamundi Hill -</b>
                        Chamundi Hills is located 13 km east of Mysore, the Palace City, in Karnataka, India. Its average elevation is 1,000 meters (3,300 ft).
                        <div id="ChamundiHills" style="display:none">
                            <p>
                    ...
                    <li class="list-group-item">
                        <b>Mysore Wax Museum - </b>
                        This museum is based on music and musical instruments.
                        This one-of-its kind museum exhibits over 100 life-size wax statues and over 300 musical instruments categorised in various bands and stage settings.
                        <div id="MysoreWaxMuseum" style="display:none">
                            <p>
                    ...
                    <li class="list-group-item">
                        <b>Mysore Zoo - </b>
                        Mysore Zoo (Now Mysuru Zoo) (officially the Sri Chamarajendra Zoological Gardens) is a 157-acre (64 ha) zoo located near the palace in Mysore, India.
                        <div id="MysoreZoo" style="display:none">
                            <p>
                                It is one of the oldest and most popular zoos in India, and is home to a wide range of species (168). Mysore Zoo is one of the city’s most popular attractions.
                    ...
                    <li class="list-group-item">
                        ...
                        <div id="Mysorepalace" style="display:none">
                            <p>
                    ...
                    <li class="list-group-item">
                        <b>St.Philomena church - </b>
                        St.Philomena church is a Catholic church that is the cathedral of the Diocese of Mysore, India. The full name is the Cathedral of St. Joseph and St. Philomena.
                        <div id="philomena" style="display:none">
                            <p>
                                It is also known as St. Joseph's Cathedral. It was constructed in 1936 using a Neo Gothic style and its architecture was inspired by the Cologne Cathedral in Germany. This is one of the tallest churches in Asia
        ...
        <div class="card classPackage mb-3">
            <div class="card-header boldfields">
                <h5>Check out our exciting  Mysore one day tour packages now and <a href="https://www.utaxi.in/Home/Packages">Book Cab with Utaxi</a></h5>
            </div>
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">

                        Tolls and vehicle parking’s will be completely extra.
                    </li>
                    <li class="list-group-item">

                        Mysore Zoo, Karanji Lake will be closed on Tuesday.

                        Mysore Zoo and Karanji Lake timings will be 10am to 6pm. Zoo tickets charges Rs-75/head and Rs-20/head respectively.
                    </li>
                    <li class="list-group-item">

                        Maintain the timings will be more important in the package or else it will be charged as extra hour depending on the vehicle type.
                    </li>
                    <li class="list-group-item">

                        Palace inside visiting hours will be 10 30am to 5 pm tickets Rs-75/head

                    </li>
                    <li class="list-group-item">
                        Palace Lighting will be only on Sunday from 7pm to 8pm.
                    </li>
                    <li class="list-group-item">
                        Sand and Wax museum timings will be 10am to 6 pm tickets Rs-50/head respectively
                    </li>
                </ul>
            </div>
        </div>
