...
<head>
    <title>
        Cab from Bangalore to Wayanad 2 Days 1 Night @ Rs.7099/-
    </title>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="robots" content="index, follow" />
    <meta name="description" content="Wayanad 3 days Packages, Cab for Bangalore to Wayanad Tour Packages, For 2 nights 3 days book cab with u taxi, Outstation cabs for sight seeing in wayanad, wayanad sightseeing cab" />
    <meta name="keywords" content="wayanad cab service, Wayanad 3 days Packages – Bangalore to Wayanad Tour Packages, 2 nights 3 days,sight seeing in wayanad, tourist cab services in wayanad, cab services in wayanad, places to visit in wayanad for 1 day, wayanad homestay, wayanad sightseeing package" />
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 535px !important;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="/Images/please-reach-out-to-our-customer-care-for-the-holiday-package-booking.png" alt="taxi airport drop for bangalore" />
            </div>
...
<div class="row" style="margin-top: 5px;">
    <div class="col-md-12">
        <div class="card classPackage mb-3" style="text-align: center;">
            <h1 style="margin-top: 20px;">Wayanad 3 Day 2 Night Trip</h1>
        </div>
    </div>
</div>
<div class="row" style="margin-top: 5px;">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="btnSearchNext">
                        ...
                        <input type="hidden" value="18" id="hdnPackageConfigurationID" />
                        <input type="hidden" value="1" id="hdnOutstationTypeID" />
                        <input type="hidden" value="1" id="hdnEnableOnlinePayment" />


                        <input type="hidden" id="hdnPackageType" value="41" />
                ...
                <div id="divBookingSuccess" class="container">
                    ...
                    <div class="form-group">
                        <div class="alert row" style="margin-left: -22px;">
                            <img style="width: 100%;" src="/Images/feedback.png" alt="utaxi cabs bangalore" title="local cheapest taxi for airport" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                <a href="https://www.facebook.com/utaxi12/?modal=admin_todo_tour" class="clsbookNow">
                                    <img style="width: 100%;" src="/Images/Social media Icon/facebook-icon-png-social-media-icons.png" alt="taxi services in bangalore" />
                                </a>
                            </div>
                            <div class="col-md-1"></div>
                            <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                <a href="https://twitter.com/Utaxi3">
                                    <img style="width: 100%;" src="/Images/Social media Icon/twitter--social-media-icons-.png" alt="innova taxi for bangalore airport" />
                                </a>
                            </div>
                            <div class="col-md-1"></div>
                            <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                <a href="https://www.google.co.in/search?q=utaxi&oq=utaxi&aqs=chrome..69i57j69i60j35i39j69i61l3.6428j1j7&sourceid=chrome&ie=UTF-8#lrd=0x3bae151ddb3b9c3b:0x453bb66e876199fc,3,,,">
                                    <img style="width: 100%;" src="/Images/Social media Icon/google-plus-3-169 (1).png" alt="taxi for sure bangalore airport flat rate" />
                                </a>
                            </div>
                            <div class="col-md-2"></div>
                        </div>
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/Images/Package/Wayanad/Wayanad-Wildlife-Sanctuary-1.png" alt="best outsation cab for wayanad" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Wayanad/Wayanad-Wildlife-Sanctuary-Parambikulam-Wildlife-Sanctuary.png" alt="taxi for wayanad package" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Wayanad/Wayanad-Wildlife-Sanctuary.png" alt="one day package fro wayanad" />
                        </div>
                    </div>
            ...
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        On arrival at Wayanad, KALPETTA/SULTHAN BATHERY. in the morning .Check in at Hotel/Resort/Homestay. After breakfast leave for  Soochipara waterfalls, It is a three-step waterfall of more than 200 ms in height with a fantastic scenery.

                    </li>
                    <li class="list-group-item">
                        Here you can enjoy water-rafting, swimming, and bathing in the pool below. This spectacular waterfall at Soochipara near Meppadi is really a treasure of nature.
                    </li>
                    <li class="list-group-item">
                        Leave to Edakkal caves have lunch from Ambalavayal. Edakkal caves are pre-historic caves lies 12km from SulthanBathery Two caves are located at a height of 1000 m on Ambukutty Mala near Ambalavayal.
                    </li>
                    <li class="list-group-item">
                        The New Stone Age pictorical writings on the walls of these natural caves at Edakkal are evidence of the civilisation that existed in these regions in prehistorical times. Back to Hotel/Resort/Homestay.

                    </li>
                    <li class="list-group-item">
                        Next day After breakfast, leave for Kuruwa Island – Kuruva Island is a vast island of 950 acres abundantly rich with green forest. It is very far from the turbulence of city life making it an exotic place for visitors to relax and enjoy the beauty of the nature.
                    </li>
                    <li class="list-group-item">
                        After that leave for Tholpetty wildlife Sanctuary. This sanctuary has a wide variety of animals. Have a nice Jeep safari in this sanctuary. Return to Hotel/Resort/Homestay.

                    </li>
                    <li class="list-group-item">
                        Next Day After breakfast, leave from Hotel/Resort/Homestay. on the way you can visit the famous tourist spot Pookode lake.
                    </li>
                    <li class="list-group-item">
    ...
    <div class="col-md-8">
        <div class="card classPackage mb-3">
            ...
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        <b>Wayanad -</b>Wayanad is a district in the north-east of Kerala state, India with headquarters at the town of Kalpetta. It is set high on the Western Ghats with altitudes ranging from 700 to 2100 m. The district was formed on 1 November 1980 as the 12th district in Kerala by carving out areas from Kozhikode and Kannur districts. The district is 3.79% urbanised, with three municipal towns Kalpetta, Mananthavady and Sulthan Bathery. There are many indigenous tribals in this area.
                        <div id="Wayanad" style="display:none">
                            <p>
                                Pulpally in Wayanad boasts of the only Lava Kusha Temple in Kerala and Vythiri has the only mirror temple in Kerala which is a Jain temple. The edicts and caves of Ambukuthimala and other evidences state that the place is as old as the beginning of the New Age Civilisation.
                            </p>
                        </div>
                        <a href="#Wayanad" class="nav-toggle">Read More</a>
                    </li>
                    <li class="list-group-item">
                        <b>Chembra Peak -</b>The Chembra peak in Wayanad is quite famous in the region and very popular amongst tourists. It is the highest elevated surface in Wayanad which is located 8 kilometres from Kalpetta. This peak shares its borders with the Nilgiri hills in Tamil Nadu and Vallarimala in Calicut.
                        <div id="ChembraPeak" style="display:none">
                            <p>
                                This peak can be visible from any part of Wayanad but if you are up for some action, then do go on a trek to the top of the peak. The trek consists of rough terrains and the altitude is approximately 2,100 metres above sea level
                            </p>
                        </div>
                        <a href="#ChembraPeak" class="nav-toggle">Read More</a>
                    </li>
                    <li class="list-group-item">
                        <b>Banasura Sagar Dam -</b>Another famous tourist spot in Wayanad is the Banasura Sagar Dam that holds back water from the renowned Karamanathodu tributary formed from the Kabini river which flows in the eastern direction in the state.
                        <div id="BanasuraSagarDam" style="display:none">
                            <p>
                                Around the dam you can find many activities that you can undertake such as trekking, biking and similar activities. many tourists visit this dam to admire its beauty and photograph it.
                            </p>
                        </div>
                        <a href="#BanasuraSagarDam" class="nav-toggle">Read More</a>
                    </li>
                    <li class="list-group-item">
                        <b>Kuruva Island -</b>The Kuruva island so colourful in terms of nature which makes it a popular tourist spot on Wayanad tourism.
                        <div id="KuruvaIsland" style="display:none">
                            <p>
                                the island is a secured river delta with many other islands surrounding it in the middle of the river Kabini. Sprawling over an area of about 950 acres, Kuruva island has a dense population and a rich fauna and flora with some rare species that you cannot find anywhere else. In the island
                            </p>
                        </div>
                        <a href="#KuruvaIsland" class="nav-toggle">Read More</a>
                    </li>
                    <li class="list-group-item">
                        <b>The Bamboo Factory -</b>The bamboo factory located in Uravuis is a very noble initiative to bring back to life the dying art of making crafts with bamboos. Uravu literally means ‘the bamboo village’.
                    </li>
                    <li class="list-group-item">
                        <b>Pookode Lake -</b>Visiting the Pookode lake in Wayanad is a must when travelling on Wayanad tour packages as it is considered one of the best places to see in the region. It is considered to be the most beautiful fresh water lake in the whole of South India and located amidst huge lush green forests and mountains at an altitude of 770 metres and above sea level

                    </li>
                    <li class="list-group-item">
                        <b>Tholpetty Wildlife Sanctuary -</b>Tholpetty Wildlife Sanctuary is a must visit place on all best tour packages for Wayanad. Situated in the western Ghats in Wayanad you can witness some of the exotic wildlife here in their natural habitat itself such as bears, monkeys, elephants, leopards, tigers, reptiles, fishes and many species of birds.

                    </li>
                    <li class="list-group-item">
                        <b>Edakkal Caves -</b>Edakkal Caves are frequently visited by all tourists visiting Wayanad and the climb up the mountains to the caves takes around 45 minutes on the Ambukuthi Mala.
                    </li>
                </ul>
            </div>
        </div>
