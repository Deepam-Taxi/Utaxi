...
<head>
    <title>
        Taxi for Innovative Film City in Bengaluru  @ Rs.1549/-
    </title>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="robots" content="index, follow" />
    <meta name="description" content="Book Cabs  for Best place to visit in bangalore. Attractions Innovative Film City in Bangalore awesome place to have fun book Utaxi. It has various attractions such as Aqua Kingdom, Cartoon City" />
    <meta name="keywords" content="taxi  for Innovative Film City Fun Entertainment, Bangalore to Innovative Film City Cabs, Book Cabs for Innovative Film City, Hire Local Cabs for best 1 day Innovative Film City in Bengaluru, mysore innovative film city" />
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 535px !important;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="/Images/please-reach-out-to-our-customer-care-for-the-holiday-package-booking.png" alt="cab services in bangalore holiday package" />
            </div>
...
<div class="row" style="margin-top: 5px;">
    <div class="col-md-12">
        <div class="card classPackage mb-3" style="text-align: center;">
            <h1 style="margin-top: 20px;">Innovative Film City Full Day Trip</h1>
        </div>
    </div>
</div>
<div class="row" style="margin-top: 5px;">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="btnSearchNext">
                        ...
                        <input type="hidden" id="hdnPackageType" value="37" />
                ...
                <div id="divBookingSuccess" class="container">
                    ...
                    <div class="form-group">
                        <div class="alert row" style="margin-left: -22px;">
                            <img style="width: 100%;" src="/Images/feedback.png" alt="airport cabs bangalore" title="book airport cabs for offres" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                <a href="https://www.facebook.com/utaxi12/?modal=admin_todo_tour" class="clsbookNow">
                                    <img style="width: 100%;" src="/Images/Social media Icon/facebook-icon-png-social-media-icons.png" alt="cabs from innovative film city" />
                                </a>
                            </div>
                            <div class="col-md-1"></div>
                            <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                <a href="https://twitter.com/Utaxi3">
                                    <img style="width: 100%;" src="/Images/Social media Icon/twitter--social-media-icons-.png" alt="innovative film city cabs" />
                                </a>
                            </div>
                            <div class="col-md-1"></div>
                            <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                <a href="https://www.google.co.in/search?q=utaxi&oq=utaxi&aqs=chrome..69i57j69i60j35i39j69i61l3.6428j1j7&sourceid=chrome&ie=UTF-8#lrd=0x3bae151ddb3b9c3b:0x453bb66e876199fc,3,,,">
                                    <img style="width: 100%;" src="/Images/Social media Icon/google-plus-3-169 (1).png" alt="innovative film city bangalore" />
                                </a>
                            </div>
                            <div class="col-md-2"></div>
                        </div>
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/Images/Package/Innovative Film City/Cartoon-City-Entrance---Innovative-Film-City---Bangalore,-India.png" alt="Bangalore to Innovative Film City Cabs " title="Cartoon City Entrance" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Innovative Film City/Innovative-Film-City-(Bengaluru).jpg" alt="Innovative Film City package" title="Innovative Film-City Bidadi" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Innovative Film City/bigg-boss-tour-innovative-film-academy-utaxi.jpg" alt="cabs to innovative film city bangalore" title="Bigg Boss Tour Innovative Film Academy" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Innovative Film City/Aqua-Kingdom.jpg" alt="cab to innovative film city" title="Aqua Kingdom" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Innovative Film City/Dino-Park-innovative-film-city-utaxi.jpg" alt="Park Timings & Entry Info - Innovative " title="" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Innovative Film City/innovative-film-city-mysore.jpg" alt="" title="Innovative Film City Waterfall" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Innovative Film City/weekend-trip-innovative.jpg" alt="Weekend Trip to Innovative Film City " title="Innovative Film City Mysore" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Innovative Film City/Dirt-biking.jpg" alt="" title="Dirt Biking" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Innovative Film City/Cartoon-City-Entrance-Innovative-Film-City.jpg" alt="" title="Cartoon City Entrance Film City" />
                        </div>
                    </div>
...
<div class="row" style="margin-top: 5px;">
    ...
    <div class="col-md-12">
        <div class="card classPackage mb-3">
            <div class="card-header boldfields">
                <h4>Bangalore to Innovative Film City Cabs </h4>
            </div>
            <div class="card-body">
                <p>Innovative Film City is an awesome place to have fun. Innovative film city is located about 40 km’s from <a href="https://www.utaxi.in/bangalore/holiday-package-taxi-services/bangalore-sightseeing-one-day-packages.aspx">Bangalore</a> on <a href="https://www.utaxi.in/bangalore/holiday-package-taxi-services/bangalore-to-mysore-one-day-tour-package.aspx">Mysore road.</a> A good strategic location as it will be accessible from both Bangalore and Mysore.</p>

                <p>Innovative film City offers loads of fun for all members of the family. Be it toddlers, older children, youth, adults or grandparents, we have amazing activities for all age groups. </p>


                <h5>Attraction places to see with utaxi <a href="https://www.utaxi.in">Book Cab</a></h5>
                <p> Popular attractions  places include Cartoon City, Aqua Kingdom, Dino Park, Mini Golf, Petting Zoo, Haunted Mansion, Mirror Maze and so much more.</p>

                <h5>Attraction places for Student</h5>
                <p>Special attractions for students include amazing International Museums and entertainment attractions with an educational value which will take the students to another world.</p>
    ...
    <div class="col-md-12">
        <div class="card classPackage mb-3">
            <div class="card-header boldfields">
                <h4>Main Attractions of the Innovative Film City</h4>
            </div>
            <div class="card-body">
                <ul class="list-group list-group-flush">

                    <li class="list-group-item"><b>Cartoon City:</b> The Cartoon City is a hot favourite amongst kids. Its flamboyance and vibrant theme are especially appealing for them, but they manage to charm adults too. The fun rides from a variety of famous cartoon characters as well as the iconic series of star wars recreate the childhood magic beautifully and make you never want to leave.</li>
                    <li class="list-group-item"><strong>Aqua Kingdom:</strong> The Aqua Kingdom is a great place to spend some quality time with friends and family, or indulge in a little romance, in the wave pool and the sandy beach. The water slides, children's play area and dance floor with an in-house DJ are a wonderful retreat from the daily humdrum life. <br></li>
                    <li class="list-group-item"><strong>Dino Park:</strong> The Dino Park has a marvellous collection of life-size dinosaurs, including a centrally hoisted 40 feet tall T-Rex skeleton and an impressive 60 feet high animatronics controlled dinosaur. A mere walk through this park is a guaranteed thrilling experience!<br></li>
                    <li class="list-group-item"><strong>Mini Golf:</strong> The perfect place for all golf enthusiasts, this 12-holes mini golf course is ideal for all those who miss the sport even when on their vacation. Do not forget to check out the authentic golf merchandise sold here. <br></li>
                    <li class="list-group-item"><strong>Haunted Mansion:</strong> There is no haunted house like this in Bangalore. Filled up with over 250 props including scary skeletons, horrifying zombies and half-bearded men; this dirty and dingy mansion will give you chills. <br></li>
                    <li class="list-group-item"><strong>Mirror Maze:</strong> This mirror maze will leave you baffled and fatigued. Beautifully done with red arches, the maze seems to go on endlessly due to the clever placement of mirrors. Brave surprising corners, dead ends and continuous circles before you make your way out. <br><br>Other than the above-listed attractions, the Film City also houses a Petting Zoo, Mining Section and Innovative Talkies.</li>
    ...
    <div class="col-md-12">
        <div class="card classPackage mb-3">
            <div class="card-header boldfields">
                <h4> Things To Do at Innovative Film City</h4>
            </div>
            <div class="card-body">
                <ul class="list-group list-group-flush">


                    <li class="list-group-item"><b>Adventurous sports: </b> A myriad of adventure sports available here are sure to give you an adrenaline rush. Enjoy go-karting on the well-equipped track, or play some net cricket and bat to the ball-throwing machine. You can also choose from other sports like dirt bike, bungee jumping, bull ride and archery. </li>
                    <li class="list-group-item"><b>Museums: </b> What starts as a simple walk across the museums turns to an informative and fun filled experience pretty soon. Enhance your community experience about how the various tribes live in India through the Tribal Museum, or sing with the Beatles and read with Shakespeare at the Wax Museum. The Oddities Museum houses everything from Star Wars to nature and science, while the Fossil Museum, with its remnants and remains from the prehistoric era, takes you back in time. <br></li>
                    <li class="list-group-item"><b>Bigg Boss Tour: </b> The Bigg Boss Tour helps you explore sets of the most famous reality show- Bigg Boss Kannada Season 4. Set on 18,000 square feet of land; enjoy clips of winning moments as well the contestants’ journey here as you tour through the house. </li>
            </div>
            </ul>
    ...
    <div class="col-md-12">
        <div class="card classPackage mb-3">
            <div class="card-header boldfields">
                <h4> Innovative Film City Entry Fee and Timings</h4>
            </div>
            <div class="card-body">
                <p>The park is open from 10:00 AM to 7:00 PM on all days. The entry ticket costs INR 799 - 974 and includes access to all standard attractions. Attractions such as Go Karting, Bungee Jumping, cricket, Dirt Bike, Bull Ride and Karaoke need to be separately paid for.</p>
