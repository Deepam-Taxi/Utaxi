...
<head>
    ...
    <meta name="description" content="Book Outstation Cabs for Ooty Coonoor Packages, Best offers on Ooty Outstation packages with u taxi, 3 Day Trip from Bangalore | Ooty Honeymoon packages | Honeymoon Package for 2 Days 1 Night" />
    <meta name="keywords" content="Ooty and coonoor trip package, outstation taxi service in bangalore, Cab from bangalore to ooty, Bangalore to Ooty One Way Taxi , cab for ooty sightseeing, Taxi Service from Bangalore to Ooty, cheapest cab from bangalore to ooty, Outstation Cabs from Bangalore to Ooty" />
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 535px !important;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="/Images/please-reach-out-to-our-customer-care-for-the-holiday-package-booking.png" alt="cab for local sightseeing in ooty" />
            </div>
...
<div class="row" style="margin-top: 5px;">
    <div class="col-md-12">
        <div class="card classPackage mb-3" style="text-align: center;">
            <h1 style="margin-top: 20px;">Ooty & Coonoor 3day 2 Night</h1>
        </div>
    </div>
</div>
<div class="row" style="margin-top: 5px;">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="btnSearchNext">
                        ...
                        <input type="hidden" value="15" id="hdnPackageConfigurationID" />
                        <input type="hidden" value="1" id="hdnOutstationTypeID" />
                        <input type="hidden" value="1" id="hdnEnableOnlinePayment" />


                        <input type="hidden" id="hdnPackageType" value="40" />
                ...
                <div id="divBookingSuccess" class="container">
                    ...
                    <div class="form-group">
                        <div class="alert row" style="margin-left: -22px;">
                            <img style="width: 100%;" src="/Images/feedback.png" alt="best cab service" title="Book Best cab service" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                <a href="https://www.facebook.com/utaxi12/?modal=admin_todo_tour" class="clsbookNow">
                                    <img style="width: 100%;" src="/Images/Social media Icon/facebook-icon-png-social-media-icons.png" alt="book cab for ooty and coonoor sightseeing" />
                                </a>
                            </div>
                            <div class="col-md-1"></div>
                            <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                <a href="https://twitter.com/Utaxi3">
                                    <img style="width: 100%;" src="/Images/Social media Icon/twitter--social-media-icons-.png" alt="cabs in ooty and coonoor" />
                                </a>
                            </div>
                            <div class="col-md-1"></div>
                            <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                <a href="https://www.google.co.in/search?q=utaxi&oq=utaxi&aqs=chrome..69i57j69i60j35i39j69i61l3.6428j1j7&sourceid=chrome&ie=UTF-8#lrd=0x3bae151ddb3b9c3b:0x453bb66e876199fc,3,,,">
                                    <img style="width: 100%;" src="/Images/Social media Icon/google-plus-3-169 (1).png" alt="local cabs in ooty and coonoor" />
                                </a>
                            </div>
                            <div class="col-md-2"></div>
                        </div>
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/Images/Package/Ooty/Bangalore-to-Ooty-Tour-Packages-Best.png" alt="bangalore to ooty cab" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Ooty/Bangalore-to-Ooty-Tour-Packages-Holiday-Packages.png" alt="ooty sightseeing cabs" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Ooty/Bangalore-to-Ooty-Tour-Packages-Packages-starting.png"  alt="ooty sightseeing cab"/>
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Ooty/Bangalore-to-Ooty-Tour-Packages.png" alt="mysore to ooty cab" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Ooty/Bangalore-to-Ooty-Tour-PackagesOoty-Tour-Packages,-List-of-Ooty-Holiday-Packages.png"alt="ooty cab rental" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Coonoor/Another-evening-on-hills-nilgiri-coonoor.png" alt="bangalore to ooty cab fare" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Coonoor/Coonoor---Famous-for-Nilgiri-hills-.png" alt="book cab from bangalore to ooty" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Coonoor/Tea-Gardens-At-Coonoor.png" alt="cab service from bangalore to ooty" />
                        </div>
                    </div>
            ...
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        Embark on your Ooty trip plan & enjoy a refreshing journey from Bangalore to Ooty as you cruise through the thrilling hairpin bends and lush forests of Nilgiris.
                    </li>
                    <li class="list-group-item">
                        On your pick up point  you will be greeted by the driver who will then transfer you from Bangalore to Ooty. The journey will take a minimum of seven hours during which you will be covering a total distance of 340 kilometers. It will be a smooth journey wherein you can relish the charm of Nilgiri mountains and its natural beauty while the lush greenery surrounds you on all sides..
                    </li>
                    <li class="list-group-item">
                        Once you reach Ooty, the driver will drop you at the hotel wherein you can complete the check-in process at Hotel Lake View, rest up for a while, and gear up to enjoy the rest of the day at your convenience. Later in the evening, you can explore the nearby areas and feel the peace and quiet that the hill station offers. While exploring the markets, indulge in a bit of shopping therapy, post which, you can call it a night at the hot.
                    </li>
                    <li class="list-group-item">
                        Start the trip as per your wish and visit the places mentioned below that provided by the trip details in the website within the time limits .
                    </li>
                    <li class="list-group-item">
                        <b>Highlights</b>
                        •	Hike to Doddabetta Peak and visit Tea Factory
                        •	Views from Dolphin's Nose and Lamb's Rock
                        •	Spend time at Sim's Park and Ketty Valley
                        •	Scenic drive through Nilgiri mountains
                        •	Connor Railway ride within the mountains and greenery of nilgiris
                        And then start your way back to Bangalore after spending the time limit of the package that is within 3 Days and 2 Nights
                    </li>
                    <li class="list-group-item">
    ...
    <div class="col-md-8">
        <div class="card classPackage mb-3">
            ...
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        <b>Gardens and parks -</b>
                        The Government Rose Garden (formerly Centenary Rose Park) is the largest rose garden in India.
                        <div id="Gardensandparks" style="display:none">
                            <p>
                                It is situated on the slopes of the Elk Hill in Vijayanagaram of Ooty town. at an altitude of 2200 meters. Today this garden has one of the largest collections of roses in the country with more than 20,000 varieties of roses of 2,800 cultivars. The collection includes hybrid tea roses, Miniature Roses, Polyanthas, Papagena, Floribunda, Ramblers, Yakimour and roses of unusual colours like black and green.
                                Xerochrysum bracteatum - Everlasting flower from Ooty. The 22-acre (89,000 m2) Ooty Botanical Gardens was laid out in 1847 and is maintained by the Government of Tamil Nadu. The Botanical Garden is lush, green, and well-maintained. A flower show along with an exhibition of rare plant species is held every May. The gardens have around a thousand species, both exotic and indigenous, of plants, shrubs, ferns, trees, herbal and bonsai plants. The garden has a 20-million-year-old fossilized tree.
                        ...
                        <a href="#Gardensandparks" class="nav-toggle">Read More</a>
                    </li>
                    <li class="list-group-item">
                        <b>Lakes and dams - </b>
                    ...
                    <li class="list-group-item">
                        ...
                        <a href="#Reserveforests" class="nav-toggle">Read More</a>
                    </li>
                    <li class="list-group-item">
                        <b>Tribal huts and museum - </b>
                        ...
                        <div id="Tribalhutsandmuseum" style="display:none">
                            <p>
                                ...
                                The Tribal Museum is part of the campus of Tribal Research Centre which is in Muthorai Palada (10 km from Ooty town). It is home to rare artefacts and photographs of tribal groups of Tamil Nadu as well as the Andaman and Nicobar Islands, and anthropological and archaeological primitive human culture and heritage. The Tribal Museum also displays houses belonging to Toda, Kota, Paniya, Kurumba and Kanikarans.
                            </p>
                        </div>
                        <a href="#Tribalhutsandmuseum" class="nav-toggle">Read More</a>
                    </li>
                    <li class="list-group-item">
                        <b>Nilgiri Mountain Railway - </b>
                        The Nilgiri Mountain Railway was built by the British in 1908, and was initially operated by the Madras Railway Company.
                        <div id="NilgiriMountainRailway" style="display:none">
                            <p>
                    ...
                    <li class="list-group-item">
                        ...
                        <a href="#Historicalbuildings" class="nav-toggle">Read More</a>
                    </li>
                    <li class="list-group-item">
                        <b>SIM’S PARK - </b>
                        ...
                        <div id="SIMSPARK" style="display:none">
                            <p>
                        ...
                        <a href="#SIMSPARK" class="nav-toggle">Read More</a>
                    </li>
                    <li class="list-group-item">
                        <b>LAMB’S ROCK - </b>
                        Named after Captain Lamb who attempted to open a path to this place, the rock drops down several hundred feet to disappear in thick jungle below. The plains of Coimbatore and surrounding valleys offer magnificent views from this spot.
                    </li>
                    <li class="list-group-item">
                        <b>DOLPHIN’S NOSE - </b>
                    ...
                    <li class="list-group-item">
                        <b>WELLINGTON - </b>
                        At a distance of 4 Kms from Coonoor Railway Station, Sim's Park was laid out in 1874 by Mr.J.D. Sim, then Secretary to Government and Major places to visit in Coonoor.
                        <div id="WELLINGTON" style="display:none">
                            <p>
                        ...
                        <a href="#WELLINGTON" class="nav-toggle">Read More</a>
                    </li>
                    <li class="list-group-item">
                        <b>LAW'S FALLS - </b>
                        ...
                        <div id="LAWSFALLS" style="display:none">
                            <p>
                                It is one of the must visit Coonoor tourist places and also one of the waterfalls in Coonoor.
                        ...
                        <a href="#LAWSFALLS" class="nav-toggle">Read More</a>
                    </li>
                    <li class="list-group-item">
                        <b>DROOG FORT - </b>
                        ...
                        <div id="DROOGFORT" style="display:none">
                            <p>
                        ...
                        <a href="#DROOGFORT" class="nav-toggle">Read More</a>
                    </li>
                    <li class="list-group-item">
                        <b>CATHERINE FALLS - </b>
                        ...
                        <div id="CATHERINEFALLS" style="display:none">
                            <p>
                        ...
                        <a href="#CATHERINEFALLS" class="nav-toggle">Read More</a>
                    </li>
                    <li class="list-group-item">
                        <b>KOTAGIRI - </b>
                        ...
                        <div id="KOTAGIRI" style="display:none">
                            <p>
                        ...
                        <a href="#KOTAGIRI" class="nav-toggle">Read More</a>
                    </li>
                    <li class="list-group-item">
                        <b>KETTI VALLEY VIEW POINT - </b>
                        ...
                        <div id="KETTIVALLEYVIEWPOINT" style="display:none">
                            <p>
                        ...
                        <a href="#KETTIVALLEYVIEWPOINT" class="nav-toggle">Read More</a>
                    </li>
                    <li class="list-group-item">
                        <b>EMERALD LAKE - </b>
                        ...
                        <div id="EMERALDLAKE" style="display:none">
                            <p>
                        ...
                        <a href="#EMERALDLAKE" class="nav-toggle">Read More</a>
                    </li>
                    <li class="list-group-item">
                        <b>AVALANCHE LAKE / SANCTUARY - </b>                            At a distance of 5 km from Emerald Lake, 23 km from Ooty & 33 km from Coonoor, Avalanche Lake is beautiful lake situated at Avalanche village in the Nilgiris district of Tamil Nadu. It is a popular eco- tourism spot and also one of the best places to visit in Ooty.
                        <div id="AVALANCHELAKESANCTUARY" style="display:none">
                            <p>
                                ...
                                The surroundings of the dam are considered as a sanctuary with variety of wildlife and offers beautiful experience to visitors in the lap of nature. Avalanche is a habitat of Wild animals like Tiger, Leopard, Gaur, Nilgiri Thar, Sambar Deer, Sloth Bear, Barking Deer, and Nilgiri Langur. Trekking enthusiasts keep flocking here to try their hands at the various trekking trails, the most popular one being the trek along Bhavani River. One can also trek up to the adjoining hills to enjoy an eagle's eye view of Ooty.
                            </p>
                        </div>
                        <a href="#AVALANCHELAKESANCTUARY" class="nav-toggle">Read More</a>
                    </li>
                </ul>
            </div>
        </div>
