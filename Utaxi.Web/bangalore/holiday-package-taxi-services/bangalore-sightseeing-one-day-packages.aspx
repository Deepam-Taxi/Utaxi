...
<head>
    <title>
         Cabs for One day Bangalore local sightseeing tour @ Rs.1699/- 
    </title>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="robots" content="index, follow" />
    <meta name="description" content="Book cabs for Bangalore 1 day Trip Sedan @ Rs. 9 per/km ,  Cabs for bangalore sightseeing packages,  Taxi for Best One Day trips, Cubbon Park,  , Bangalore Palace , Iskcon Temple, bangalore one day trip cabs " />
    <meta name="keywords" content="taxi  for sightseeing places in bangalore,  Outstation cab for Shiva Temple Bangalore |Kempfort, Old Airport Road| Darshan Timings,  cabs for one day sightseeing around bangalore, Isckon Temple in Bangalore, Book Taxi  for Hare Krishna Hill Temple, Art of Living Bangalore , Sri Sri Ravi Shankar Ashram, Outstation cab for Vidhana Soudha Bangalore - Timings, Entry Fees, , cab for Bannerghatta National Park Safari, Timings, Entry Fee, Bangalore Zoo,  Shivoham Shiva Temple,  Raja Rajeshwari Temple,  RR Nagar Bangalore" />
...
<script src="/bundles/OutstationPackage?v=yAxDV3NRR7y1rOOvxmat5XJByB3W9bqRdfCroRPpE-Y1"></script>
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 535px !important;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="/Images/please-reach-out-to-our-customer-care-for-the-holiday-package-booking.png" alt="Best Holiday packages" />
            </div>
...
<div class="row" style="margin-top: 5px;">
    <div class="col-md-12">
        <div class="classPackage mb-3" >
            <h1 style="margin-top: 20px;text-align: center">One Day Sightseeing in Bangalore</h1>
        </div>
    </div>
</div>
<div class="row" style="margin-top: 5px;">
            ...
            <div class="card-body">
                <div class="container" id="divSearchRides">
                    ...
                    <div class="form-group" id="btnSearchNext">
                        ...
                        <input type="hidden" value="3" id="hdnPackageConfigurationID" />
                ...
                <div id="divBookingSuccess" class="container">
                    ...
                    <div class="form-group">
                        <div class="alert row" style="margin-left: -22px;">
                            <img style="width: 100%;" src="/Images/feedback.png" title="Best taxi for airport pickup" alt="taxi services in bangalore " />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                <a href="https://www.facebook.com/utaxi123" class="clsbookNow" alt="bangalore one day tour packages">
                                    <img style="width: 100%;" src="/Images/Social media Icon/facebook-icon-png-social-media-icons.png" alt="cabs for airport pickup" />
                                </a>
                            </div>
                            <div class="col-md-1"></div>
                            <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                <a href="https://twitter.com/Utaxi3">
                                    <img style="width: 100%;" src="/Images/Social media Icon/twitter--social-media-icons-.png" alt="bangalore to mysore one day trip cab" />
                                </a>
                            </div>
                            <div class="col-md-1"></div>
                            <div class="col-md-2" style="border: 1px solid #eaeaea; padding: 5px; text-align: center;">
                                <a href="https://www.google.co.in/search?q=utaxi&oq=utaxi&aqs=chrome..69i57j69i60j35i39j69i61l3.6428j1j7&sourceid=chrome&ie=UTF-8#lrd=0x3bae151ddb3b9c3b:0x453bb66e876199fc,3,,," alt="taxi services in bangalore">
                                    <img style="width: 100%;" src="/Images/Social media Icon/google-plus-3-169 (1).png" alt="cab for outstation 1day package" />
                                </a>
                            </div>
                            <div class="col-md-2"></div>
                        </div>
    ...
    <div class="col-md-6">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/Images/Package/Bangalore Darshan/bangalore-darshan-package-1.png" title="Silicon Valley Bangalore" alt="bangalore sightseeing packages full day" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Bangalore Darshan/bangalore-darshan-package-art-of-living-bangalore.png" alt="Art of Living Bangalore Ashram" title="Art of Living | Sri Sri Ravi Shankar Ashram" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Bangalore Darshan/bangalore-palace.png" alt="Enjoy the beauty of Bangalore Palace" title="Bangalore Palace" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Bangalore Darshan/bangalore-iskcon-sri-radha-krishna-temple.jpg" alt="ISKCON Bangalore Spiritual Haven On Earth" title="Iskcon Sri Radha Krishna Temple Rajajinagar" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Bangalore Darshan/bangalore-darshan-package-Sri-Kailash-Ashrama-Mahasamsthana-Rajeshwar-Temple.png" title="Raja Rajeshwari Temple, Bangalore" alt="Bangalore Sri Rajarajeswari Temple RR Nagar temple " />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Bangalore Darshan/bangalore-darshan-package-vidhanasoudha.png" title="Vidhana Soudha Bangalore" alt="vidhana soudha golden jubilee" />
                        </div>

                        <div class="carousel-item">
                            <img src="/Images/Package/Bangalore Darshan/Bannerghatta-National-Park.jpg" title="Bannerghatta National Park" alt="Bannerghatta National Park Safari, Timings, Entry Fee | Bangalore Zoo" />
                        </div>
                        <div class="carousel-item">
                            <img src="/Images/Package/Bangalore Darshan/Shiv-Statue-Kempfort-Shiv-Temple.jpg" title="Big Shiva Temple" alt="Shiva Temple Bangalore | Kempfort, Old Airport Road| Darshan Timings" />
                        </div>
                    </div>
        ...
        <div class="tab">
            <button class="links" onclick="openLang(event,'HTML')">Minimum km per day</button>
            <button class="links" onclick="openLang(event,'CSS')">Fare for Driver Batta</button>
            <button class="links" onclick="openLang(event,'JS')">Toll & Parking Fee</button>
            <button class="links" onclick="openLang(event,'PHP')">Luggage Capacity</button>
        </div>
        <div id="HTML" class="content">
            <h3>Minimum Km Per Day 250</h3>
            <p>Cab for 2 days then we will charged Minimum 250 kms x 2 days = 500 kms or else if One day 200km next day 300km no issue</p>
        </div>
        <div id="CSS" class="content">
            <h3> Hire/Rent a cab for local & outstation</h3>
            <p>Book oneway or roundtrip outstation cab at best price. Day time driver Batta Rs.300/- and Night time Driver Batta Rs.300/-</p>
        </div>
        <div id="JS" class="content">
            <h3>Toll and Parking Charges</h3>
            <p>Your driver will pay the State Permit, Toll charges and Parking charges will be extra as applicable from Customers</p>
        </div>
...
<div class="row" style="margin-top: 5px;">
    <div class="col-md-12">
        <div class="card classPackage mb-3">
            <div class="card-header boldfields">
                <h5>Bangalore One Day Tour Package</h5>
            </div>
            <div class="card-body">

                <h5>Full description</h5>
                <p>What better way to spend a day in India than on a day tour of thrilling Bangalore? Take this sightseeing tour to see the capital of the Indian state of Karnataka, located on the Deccan Plateau. This city is full of bustle, due to its number of well-recognized colleges and research institutions, software companies, aerospace and telecommunication companies, and defense organizations.</p>

                <p>You can experience the day-to-day life in Bangalore as you travel to see its various sights. Breathe in the scents of flowers and water at Lal Bagh, a large botanical garden whose name translated means “The Red Garden”, and then visit Cubbon Park, a landmark “lung” area full of flora and fauna.</p>

                <p>While the gardens give Bangalore its nickname as “The Garden City”, you will also see many famous historic sights. The Nandi (Bull) Temple, built in 1537, is truly a sight to behold. This is said to house one of the largest Nandi murthi in the world, a huge statue representing the sacred bull. You will also see the imposing Vidhana Soudha, a massive, granite, Neo-Dravidian-style building that is the seat of the state legislature of Karnataka.</p>

                <p>As “The Garden City”, Bangalore has so much to offer. Take the opportunity to visit this unique green city and pay respect to its beautiful architecture and ancient monuments.</p>


                <p>Bengaluru is the capital of the Indian state Karnataka. The city was known as the "Garden City of India".</p>
                <p>Bengaluru was one of the most important tourist centers of the Karnataka state. Central business district of Bengaluru consists of places MG Road, Brigade Road, Commercial Street, Vidhana Soudha etc. Bengaluru had many lakes and parks.</p>

                <p>You can start the trip by making your own choice within these places in Bangalore , because due to the traffic  jams you cant able to manage the visits for the places mentioned .</p>

                <h5>Highlights</h5>
                <li class="list-group-item">Learn firsthand why Bangalore is called "The Green City"    </li>
                <li class="list-group-item">Stare up at the imposing granite Vidhana Soudha    </li>
                <li class="list-group-item">Smell the flowers in the Lal Bagh botanical garden    </li>
                <li class="list-group-item">	See the stunning Bull Temple    </li>
                <li class="list-group-item">Relax in the green of Cubbon park</li>


                <h5>Start from morning 8am to 8pm 12 hrs package</h5>
                <h6>Places Covered are</h6>
                <p>ISCON TEMPLE, Vidhana Soudha of Karnataka assembly , The high Court of Bangalore  ,Tippu Palace , Basavanagudi Bull Temple ,Sir Vishveshvaraya industrial Mueseum, Planetorium, Karnataka Silk Emporium in MG Road, Cubbon Park , Lumbini Gardens ,Bannerghatta National Park , Government Mueseum, The Big Shiva Temple in Bangalore Old Airport Road, Botanical garden, fun world.</p>


                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        ISCON TEMPLE  timings will be morning 7:15am to 1pm and in afternoon  4:30pmto 8:30pm
                    </li>
                    <li class="list-group-item">
                        Bannerghatta National park  timings will be 9am to 4pm
                    </li>
                    <li class="list-group-item">
                        Vidhana Soudha and the High Court will remain open as per government times like 10am to 6pm
                    </li>
                    <li class="list-group-item">
                        Sir Vishveshvaraya industrial Mueseum,  Planetorium , Karnataka Silk Emporium in MG Road, Cubbon Park , Lumbini Gardens ,
                    </li>
                    <li class="list-group-item">
                        Sri Visweshwraya Mueseum Timings will be morning 9:30am to 6pm.
                    </li>
                    <li class="list-group-item">
                        The Bull Temple Timings will be 6am to 12pm and again 5:30pm to 9pm
                    </li>
                    <li class="list-group-item">
                        The Big Shiva Temple In old Airport Road morning  9am to 7pm
                    </li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4" style="padding: 20px;color: #fff;">
                        ...
                        <ul class="w3ls-footer-bottom-list" style="color:#fff;list-style: none;">
                            ...
                            <li> <i class="fa fa-phone" aria-hidden="true"></i>  <a href="tel:08041466888" style="color: #ffffff;">Call 080 4684 4684</a>     </li>
