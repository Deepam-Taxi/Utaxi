...
{
    public class TavarekeretoAirporttransferController : Controller
    {
        // GET: cheapesttaxiinbangalore/TavarekeretoAirporttransfer
        ...
        {
            ViewBag.Title = "Book Taxi  from Tavarekere to Airport Pickup Rs 474/-";
            ViewBag.Description = "Looking for Best and cheapest airport cabs from Tavarekere to Bangalore Airport Taxi, We Offer A Good Rate For Taxi in The City for Airport Drop";
