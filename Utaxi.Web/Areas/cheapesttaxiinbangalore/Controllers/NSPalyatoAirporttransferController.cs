...
{
    public class NSPalyatoAirporttransferController : Controller
    {
        // GET: cheapesttaxiinbangalore/NSPalyatoAirporttransfer
        ...
        {
            ViewBag.Title = "Book Taxi from NS Palya to Airport Pickup Rs 474/-";
            ViewBag.Description = "Looking for Best and cheapest airport cabs from NS Palya  to Bangalore Airport Taxi, We Offer A Good Rate For Taxi in The City for Airport Drop";
