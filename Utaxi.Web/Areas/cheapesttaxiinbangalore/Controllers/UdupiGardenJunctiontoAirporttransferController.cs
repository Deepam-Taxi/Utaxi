...
{
    public class UdupiGardenJunctiontoAirporttransferController : Controller
    {
        // GET: cheapesttaxiinbangalore/UdupiGardenJunctiontoAirporttransfer
        ...
        {
            ViewBag.Title = "Book Taxi from Udupi Garden to Airport Pickup Rs 474/-";
            ViewBag.Description = "Looking for Best and cheapest airport cabs from Udupi Garden to Bangalore Airport Taxi, We Offer A Good Rate For Taxi in The City for Airport Drop";
        ...
        {
            ViewBag.Title = "Cab Services in Bangalore from Udupi Garden to Airport Drop Rs 674/- ";
            ViewBag.Description = "Looking for Best and cheapest airport cabs from Udupi Garden to Bangalore Airport Drop, We Offer A Good Rate For Taxi in The City for Airport Pickup";
            ViewBag.Keywords = "bangalore airport transfer, airport drop taxi bangalore, airport drop bangalore, airport drop bangalore offer, bangalore airport drop offers, bangalore airport drop, airport drop taxi bangalore, airport drop bangalore 500 rs, airport drop taxi bangalore, cab for airport drop in bangalore, airport pickup and drop bangalore, bangalore airport drop taxi offers, city taxi bangalore airport drop, airport drop taxi, bangalore airport drop taxi, airport pickup and drop,  bangalore airport drop cab, bangalore airport drop flat rate, bangalore airport to Udupi Garden, Udupi Garden to bangalore airport";
            return View();
        }
        public ActionResult AirportRoundTrip()
        {
            ViewBag.Title = "Udupi Garden to Airport round trip | just Rs 1220/- Including Hour Waiting | No Toll Charge Parking Charge";
            ViewBag.Description = "Book Taxi for Round Trip One Way from Udupi Garden, Local & Outstation Cab Service in Bangalore. Get multiple car options withU Taxi like - Hatchback, Sedan & SUV";
