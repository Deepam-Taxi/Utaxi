...
{
    public class StJohnsJunctiontoAirporttransferController : Controller
    {
        // GET: cheapesttaxiinbangalore/StJohnsJunctiontoAirporttransfer
        ...
        {
            ViewBag.Title = "Book Taxi  from St Johns Junction to Airport Pickup Rs 474/-";
            ViewBag.Description = "Looking for Best and cheapest airport cabs from St Johns Junction to Bangalore Airport Taxi, We Offer A Good Rate For Taxi in The City for Airport Drop";
        ...
        {
            ViewBag.Title = "Cab Services in Bangalore from St Johns Junction to Airport Drop Rs 674/- ";
            ViewBag.Description = "Looking for Best and cheapest airport cabs from St Johns Junction to Bangalore Airport Taxi, We Offer A Good Rate For Taxi in The City for Airport Pickup";
        ...
        {
            ViewBag.Title = "St Johns Junction to Airport round trip | just Rs 1220/- Including Hour Waiting | No Toll Charge Parking Charge";
            ViewBag.Description = "Book Taxi for Round Trip One Way from St Johns Junction, Local & Outstation Cab Service in Bangalore. Get multiple car options withU Taxi like - Hatchback, Sedan & SUV";
