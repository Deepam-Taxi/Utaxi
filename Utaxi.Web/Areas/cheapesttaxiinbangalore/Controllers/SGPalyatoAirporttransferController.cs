...
{
    public class SGPalyatoAirporttransferController : Controller
    {
        // GET: cheapesttaxiinbangalore/SGPalyatoAirporttransfer
        ...
        {
            ViewBag.Title = "Book Taxi from SG Palya to Airport Pickup Rs 474/-";
            ViewBag.Description = "Looking for Best and cheapest airport cabs from SG Palya to Bangalore Airport Taxi, We Offer A Good Rate For Taxi in The City for Airport Drop";
